...
* Make sure you use "winstarcloud_mqtt_broker" as the initial database name.
...
az postgres flexible-server create --location $AKS_LOCATION --resource-group $AKS_RESOURCE_GROUP \
  ...
  --version 15 -d winstarcloud_mqtt_broker
```
{: .copy-code}
...
```text
{
  ...
  "databaseName": "winstarcloud_mqtt_broker",
  "firewallName": "AllowAllAzureServicesAndResourcesWithinAzureIps_2021-11-17_15-45-6",
  "host": "tbmq-db.postgres.database.azure.com",
  "id": "/subscriptions/daff3288-1d5d-47c7-abf0-bfb7b738a18c/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/flexibleServers/winstarcloud_mqtt_broker",
  "location": "East US",
  "password": "postgres",
...
```text
INFO  o.t.m.b.i.WinstarcloudMqttBrokerInstallService - Installation finished successfully!
```
...
Follow [this guide](https://winstarcloud.io/docs/user-guide/mqtt-over-ssl/) to create a .pem file with the SSL certificate. Store the file as _server.pem_ in the working directory.
