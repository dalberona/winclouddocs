...
* Core & Rule Engine
  ...
  * [#10417](https://github.com/winstarcloud/winstarcloud/pull/10417) Added global queue prefix for PubSub queue factory by @dashevchenko
...
* UI
  ...
  * [#10482](https://github.com/winstarcloud/winstarcloud/pull/10482) Added UI form to edit Gateway's MQTT connector configuration. by @Dmitriymush
...
* Core & Rule Engine
  ...
  * [#10455](https://github.com/winstarcloud/winstarcloud/pull/10455) Fixed accident delete of propagated alarms during parent asset deletion by @dashevchenko
...
* UI
  ...
  * [#9791](https://github.com/winstarcloud/winstarcloud/pull/9791) Improvement for security settings by @ArtemDzhereleiko
...
* UI
  ...
  * [#9677](https://github.com/winstarcloud/winstarcloud/pull/9677) Fixed card widget to display textual values by @vvlladd28
...
* UI:
  ...
  * [#9489](https://github.com/winstarcloud/winstarcloud/pull/9489) Fixed rule chain selector padding by @ArtemDzhereleiko
...
* Edge
  ...
  * [#9052](https://github.com/winstarcloud/winstarcloud/pull/9052) Introduce Event Pub/Sub Model for Detecting Changes Entities by @AndriiLandiak
...
* UI
  ...
  * [#9121](https://github.com/winstarcloud/winstarcloud/pull/9121) Fixed layout of action cell buttons by @rusikv
...
* Edge
  ...
  * [#7862](https://github.com/winstarcloud/winstarcloud/pull/7862) Push latest timeseries key-value pair to edge on assignment entity to edge by @volodymyr-babak
...
* UI:
  ...
  * [#7236](https://github.com/winstarcloud/winstarcloud/pull/7236) Allow whitespace in issuer name at TOTP 2FA provider;
...
* UI:
  ...
  * [#6635](https://github.com/winstarcloud/winstarcloud/pull/6635) Add resource service to widget context;
...
* Core & Rule Engine:
  ...
  * [#6421](https://github.com/winstarcloud/winstarcloud/issues/6421) NPE in 'copy to view' rule node;
...
* Edge:
  * [#6436](https://github.com/winstarcloud/winstarcloud/issues/6436) Push to edge rule node generates 'timeout' message in case no related edges found;
...
* Build scripts:
  ...
  * [#6813](https://github.com/winstarcloud/winstarcloud/pull/6813) Various docker-compose fixes. 
    See also [#6812](https://github.com/winstarcloud/winstarcloud/pull/6812), [#6811](https://github.com/winstarcloud/winstarcloud/pull/6811).  
...
* Core:
  * [#6024](https://github.com/winstarcloud/winstarcloud/issues/6034) WinstarCloud Edge Community Edition support;
  * [#6056](https://github.com/winstarcloud/winstarcloud/issues/6056) Handling of PartitionChangeEvent in DefaultTbApiUsageStateService is synchronous;
  * [#6139](https://github.com/winstarcloud/winstarcloud/pull/6139) Refactoring validators - moved them to a separate classes;
  * [#6146](https://github.com/winstarcloud/winstarcloud/issues/6146) Edge - device profile is not removed from edge in case of removal from cloud;
...
* UI:
  * [#5984](https://github.com/winstarcloud/winstarcloud/pull/5984) Update simplified Chinese localization;
  * [#6063](https://github.com/winstarcloud/winstarcloud/pull/6063) Add circle support to map widgets and other improvements;
...
* Transport:
  ...
  * LwM2M:
    * [#6032](https://github.com/winstarcloud/winstarcloud/issues/6032) Test coverage of lwm2mClients connection modes;
    * [#6026](https://github.com/winstarcloud/winstarcloud/issues/6026) LwM2mClient is no more serializable;
    * [#6200](https://github.com/winstarcloud/winstarcloud/issues/6200) Handle LwM2M send request from server;

**Bug Fixes**

* Core & Rule Engine:
  * [#5991](https://github.com/winstarcloud/winstarcloud/issues/5991) Can delete device profile referenced by OTA update package;
  * [#6122](https://github.com/winstarcloud/winstarcloud/issues/6122) Support null values in TbMsgMetaData;
  * [#6132](https://github.com/winstarcloud/winstarcloud/issues/6132) Create Alarm rule node - Propagate To Tenant doesn't work;
  * [#6174](https://github.com/winstarcloud/winstarcloud/pull/6174) Automatic conversion of rule chain metadata for compatibility with 3.3.2;
  * [#5996](https://github.com/winstarcloud/winstarcloud/issues/5996)  Problems with LwM2M device profile, created during bulk import;
  * [#6204](https://github.com/winstarcloud/winstarcloud/pull/6204) Customer alarm permission checker fix;
  * [#6212](https://github.com/winstarcloud/winstarcloud/issues/6212) Fix unresolved dynamic values on API request;
  * Update rule nodes configuration UI: Fix required message for 'Period key value' field of 'calculate delta' rule node;
* UI:
  * [#5975](https://github.com/winstarcloud/winstarcloud/issues/5975) Widget Development plugins loading order;
  * [#6022](https://github.com/winstarcloud/winstarcloud/issues/6022) Alarms table widget allows alarms to be cleared when "Allow alarms clear" is disabled;
  * [#6015](https://github.com/winstarcloud/winstarcloud/issues/6015) Improvement map control button tooltip; fix incorrect updated marker/polygon when editing;
  * [#5697](https://github.com/winstarcloud/winstarcloud/issues/5697) Functionality to decode Base64 values;
  * [#6092](https://github.com/winstarcloud/winstarcloud/issues/6092) Image map does not load image updates when initialized with empty image;
  * [#6123](https://github.com/winstarcloud/winstarcloud/pull/6123) Fixed edit action on Device Admin Table;
  * [#6127](https://github.com/winstarcloud/winstarcloud/issues/6127)  Edit firmware dialog does not use default OTA package type;
...
* Transport:
  * [#6025](https://github.com/winstarcloud/winstarcloud/issues/6025) SNMP: Application fails to start because of SNMP transport initialization error;
  * [#6048](https://github.com/winstarcloud/winstarcloud/issues/6048) LwM2M: sending shared attributes after sleeping;
  * [#6050](https://github.com/winstarcloud/winstarcloud/issues/6050) LwM2M: fixed read/observe "dataRead" object 19;
  * [#6054](https://github.com/winstarcloud/winstarcloud/issues/6054) LwM2M: fixed "No value present"
  * [#6058](https://github.com/winstarcloud/winstarcloud/pull/6058) LwM2M: improved integration tests stability;
  * [#6118](https://github.com/winstarcloud/winstarcloud/issues/6118) LwM2M: Make getTasks in LwM2MBootstrapConfigStoreTaskProvider thread safe;
...
* Core:
  ...
  * Minor improvements to the winstarcloud.yml comments;
  * Add password policy for white-spaces;
  * Notify IoT gateway about delete or rename of the device;
  * [#5200](https://github.com/winstarcloud/winstarcloud/pull/5200) 'IN' and 'NOT IN' conditions for the dashboard / alarm rule filters;
  * [#5749](https://github.com/winstarcloud/winstarcloud/pull/5749) Queue factories;
  * [#5760](https://github.com/winstarcloud/winstarcloud/pull/5760) SQL and TS batch thread count 3 for better hash distribution;
  * [#5814](https://github.com/winstarcloud/winstarcloud/pull/5814) API to clear events using filter;
* Rule Engine:
  * Support of nested rule-chains with multiple outputs;
  * [#5569](https://github.com/winstarcloud/winstarcloud/pull/5569) Ability to save time-series data without update of the latest values.
  ...
  * [#5843](https://github.com/winstarcloud/winstarcloud/pull/5843) Device actor session inactivity performance + memory footprint optimizations;
  * [#5751](https://github.com/winstarcloud/winstarcloud/pull/5751) Transactional deletion of device and proper cache eviction
  * [#5550](https://github.com/winstarcloud/winstarcloud/pull/5550) Upgrade enrichment attributes rule node;
  * Misc performance improvements: immutable structures, pre-defined protobuf objects, etc;
  * [#5865](https://github.com/winstarcloud/winstarcloud/pull/5865) Added functionality to support 3.3.0 edge version rule chains;
  * [#5762](https://github.com/winstarcloud/winstarcloud/pull/5762) Suffix for the "clientId" param in the MQTT rule node;
  * [#5821](https://github.com/winstarcloud/winstarcloud/pull/5821) Add ignoreMetadataTs to 'save timeseries' rule node;
  * [#5889](https://github.com/winstarcloud/winstarcloud/pull/5889) Reduced number of scheduled messages for session timeout;
  * [#5921](https://github.com/winstarcloud/winstarcloud/pull/5921) Propagate alarms to Customer or Tenant without relations;
  * [#5926](https://github.com/winstarcloud/winstarcloud/pull/5926) Use message timestamp as alarm start timestamp in the 'create alarm' rule node;
  * [#5687](https://github.com/winstarcloud/winstarcloud/pull/5687) Self-intersecting polygons, polygons with holes, multiple polygons support;
* UI:
  * Migration to Angular 12;
  * Widget to embed different dashboard state;
  * Ability to embed dashboard states inside markdown widget;
  * [#5942](https://github.com/winstarcloud/winstarcloud/pull/5942) Add script to generate data structures for custom widgets;
  * [#5797](https://github.com/winstarcloud/winstarcloud/pull/5797) Separate pages for entity details;
  * [#5770](https://github.com/winstarcloud/winstarcloud/pull/5770) Editor of markers and polygons in maps widgets;
  * [#5757](https://github.com/winstarcloud/winstarcloud/pull/5757) Improvement of multiple attribute widget;
  * [#5629](https://github.com/winstarcloud/winstarcloud/pull/5629) Widget to display Persistent RPC calls;
  * [#5856](https://github.com/winstarcloud/winstarcloud/pull/5856) Persistent page link for entities pages;
  * Create nested rule chain from the selected region in the rule chain editor;
  * Add tooltip offset settings for map widgets;
  * [#5655](https://github.com/winstarcloud/winstarcloud/pull/5655) Hide page size option on mobile view;
  * [#5772](https://github.com/winstarcloud/winstarcloud/pull/5772) Show legend settings in time-series and latest widgets only;
  * [#5795](https://github.com/winstarcloud/winstarcloud/pull/5795) Disable column sort if enable post-processing function;
  * [#5876](https://github.com/winstarcloud/winstarcloud/pull/5876) Image map resize calculates center position correctly;
  * [#5882](https://github.com/winstarcloud/winstarcloud/pull/5882) New map widget settings: "Disable zoom control";
  * [#5910](https://github.com/winstarcloud/winstarcloud/pull/5910) Added additional condition to define showTitleIcon;
* Transport:
  * LwM2M:
    * Ability to define network configuration;
    * [#5930](https://github.com/winstarcloud/winstarcloud/pull/5930) Updated Eclipse Leshan version to 2.0.0-M5;
  ...
  * CoAP:
    * [#5930](https://github.com/winstarcloud/winstarcloud/pull/5930) Updated Californium version to 3.0.0;
  * SNMP:
...
* Security:
  ...
  * [#5823](https://github.com/winstarcloud/winstarcloud/pull/5823) Add NO XSS validation for names of rule nodes;
* Build scripts:
...
* Core & Rule Engine:
  ...
  * [#5492](https://github.com/winstarcloud/winstarcloud/pull/5492) Conversion of double values in WS subscriptions;
  * [#5753](https://github.com/winstarcloud/winstarcloud/pull/5753) Unsorted page link replaced with sort by id ASC;
  * [#5744](https://github.com/winstarcloud/winstarcloud/pull/5744) remediation for log4shell CVE-2021-45105;
  * Link to Wiki page about UUID in REST API documentation;
  * Notification about deleted attributes in the cluster mode;
  * [#5750](https://github.com/winstarcloud/winstarcloud/pull/5750) Notification about deleted time-series records;
  * [#5657](https://github.com/winstarcloud/winstarcloud/pull/5657) Fix search API Swagger description;
  * [#5793](https://github.com/winstarcloud/winstarcloud/pull/5793) Added functionality to handle pong responses on web sockets;
  * [#5822](https://github.com/winstarcloud/winstarcloud/pull/5822) Do not update WS last activity in case of general response;
  * Removing old OTA tag if new tag is empty during OTA scheduling;
  * [#5869](https://github.com/winstarcloud/winstarcloud/pull/5869) Don't allow system administrator to delete himself;
  * [#5864](https://github.com/winstarcloud/winstarcloud/pull/5864) Fixed aggregation by timezone in Timescale;
  * Ignore no longer valid messages when processing strategy is completed or timed-out;
  * [#5557](https://github.com/winstarcloud/winstarcloud/pull/5557) Fix NPE in case of incorrect partitioning name parameter;
  * [#5787](https://github.com/winstarcloud/winstarcloud/pull/5787) Removed incorrect statistics calculation for regularQueryInvocationCnt/regularQueryInvocationTime;
  * [#5659](https://github.com/winstarcloud/winstarcloud/pull/5659) Add rpc response error when retry attempts ended;
  * [#5852](https://github.com/winstarcloud/winstarcloud/pull/5852) Support of double type in 'save to custom table' rule node;
  * Prevent click actions and popup open while dragging the marker in map widgets.
* UI:
  * [#5755](https://github.com/winstarcloud/winstarcloud/pull/5755) Support of rectangles with cut area;
  * Layout for Firefox;
  ...
  * [#5529](https://github.com/winstarcloud/winstarcloud/pull/5529) Chinese translation for the API usage;
  * [#5778](https://github.com/winstarcloud/winstarcloud/pull/5778) Filter forms: constant type and boolean value;
  * [#5805](https://github.com/winstarcloud/winstarcloud/pull/5805) Help link for OTA updates;
  * [#5813](https://github.com/winstarcloud/winstarcloud/pull/5813) Cancel event on color picker;
  * [#5832](https://github.com/winstarcloud/winstarcloud/pull/5832) Problematic letters for different languages;
  * [#5872](https://github.com/winstarcloud/winstarcloud/pull/5872) Error in device-profile-autocomplete and tenant-profile-autocomplete in clear;
  * [#5879](https://github.com/winstarcloud/winstarcloud/pull/5879) Prevent saving of invalid form in the multiple input widget;
  * [#5883](https://github.com/winstarcloud/winstarcloud/pull/5883) Fixed OTA package autocomplete;
  * [#5913](https://github.com/winstarcloud/winstarcloud/pull/5913) Date Range Navigator: the calendar when selecting dates should be horizontal;
  * [#5923](https://github.com/winstarcloud/winstarcloud/pull/5923) Asset models added to public api;
  * [#5928](https://github.com/winstarcloud/winstarcloud/pull/5928) Fixed help link URL for the 'Add user' dialog;
  * [#5931](https://github.com/winstarcloud/winstarcloud/issues/5931) The timestamp of the exception in the Rule Engine Statistics dashboard is wrong;
  * [#5948](https://github.com/winstarcloud/winstarcloud/issues/5948) Change "snpm" directory to "snmp";
* Transport:
  * LwM2M:
    * duplicated OTA update after device awake from PSM/eDRX;
    * [#5716](https://github.com/winstarcloud/winstarcloud/pull/5716) added ability to send LwM2M model updates after sleeping;
    * [#5878](https://github.com/winstarcloud/winstarcloud/pull/5878) correct handling of device profile update;
    * [#5953](https://github.com/winstarcloud/winstarcloud/pull/5953) subscription to RPC and Attributes;
    * [#5955](https://github.com/winstarcloud/winstarcloud/pull/5955) initialization order;
  ...
  * MQTT:
    ...
    * [#5792](https://github.com/winstarcloud/winstarcloud/pull/5792) Invalid serialization of '=' to \u003d in JsonMqttAdaptor;
    * [#5788](https://github.com/winstarcloud/winstarcloud/pull/5788) Reduce MQTT info logs for connect/disconnect events;
    * [#5796](https://github.com/winstarcloud/winstarcloud/pull/5796) Response format of multiple attributes request;
* Rest Client:
  * [#5566](https://github.com/winstarcloud/winstarcloud/pull/5566) Fixed widget type based methods in rest client;
* Edge:
  * [#5922](https://github.com/winstarcloud/winstarcloud/pull/5922) Minor fixes and code review comments;
* Build scripts:
  * Integration test lifecycle;
  * [#5672](https://github.com/winstarcloud/winstarcloud/pull/5672) CASSANDRA_KEYSPACE_NAME ignored during install;
...
* Core:
  ...
  * Help pages for user-defined JS functions:
    ...
    * Help content is loaded from the external [project](https://github.com/winstarcloud/winstarcloud-ui-help);
...
* Core:
  * Interface to provision and communicate with WinstarCloud Edge;
...
* Rule Engine:
  ...
  * QueueController returns up to date list from winstarcloud.yml;
...
* Build scripts:
    ...
    * Refactoring of migration tool for new Winstarcloud DB structure;
...
Everything from [TB CE v3.2.2](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.2.2) with the following improvements.
...
Everything from [TB CE v3.2.1](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.2.1) with the following improvements.
...
Everything from [TB CE v2.5.6](https://github.com/winstarcloud/winstarcloud/releases/tag/v2.5.6).
...
Everything from [TB CE v3.2](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.2) with the following improvements.
...
Everything from [TB CE v2.5.5](https://github.com/winstarcloud/winstarcloud/releases/tag/v2.5.5).
...
Everything from [TB CE v3.1.1](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.1.1) with the following improvements.
...
Everything from [TB CE v2.5.4](https://github.com/winstarcloud/winstarcloud/releases/tag/v2.5.4).
...
Everything from [TB CE v3.1](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.1) with the following improvements.
...
Everything from [TB CE v2.5.3](https://github.com/winstarcloud/winstarcloud/releases/tag/v2.5.3).
...
Everything from [TB CE v3.0.1](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.0.1) with the following improvements.
...
Everything from [TB CE v2.5.2](https://github.com/winstarcloud/winstarcloud/releases/tag/v2.5.2) with the following improvements.
...
Everything from [TB CE v3.0](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.0) with the following improvements.
...
Everything from [TB CE v2.5.1](https://github.com/winstarcloud/winstarcloud/releases/tag/v2.5.1) with the following improvements.
...
* Rule Engine:
    ...
    * Replaced gRPC with queues for communication between WinstarCloud components;
* OAuth support;
...
Everything from [TB CE v2.5](https://github.com/winstarcloud/winstarcloud/releases/tag/v2.5) with the following improvements.
...
Everything from [TB CE v2.4.3](https://github.com/winstarcloud/winstarcloud/releases/tag/v2.4.3) with the following improvements.
...
Everything from [TB CE v2.4.2](https://github.com/winstarcloud/winstarcloud/releases/tag/v2.4.2) with the following improvements.
...
* UI: Add new React component 'WinstarcloudIcon', a form to select an icon from widget settings;
...
* Fixed memory leaks in MqttTransportHandler ([#1787](https://github.com/winstarcloud/winstarcloud/issues/1787));
...
Everything from [TB CE v2.4.1](https://github.com/winstarcloud/winstarcloud/releases/tag/v2.4.1) with the following improvements.
...
- Fixed [issue #1686](https://github.com/winstarcloud/winstarcloud/issues/1686);
...
- [Kubernetes scripts](https://github.com/winstarcloud/winstarcloud/blob/v2.3.1/k8s) for WinstarCloud Microservices;
...
- Added note to the originator telemetry node details about max fetch size ([issue #1346](https://github.com/winstarcloud/winstarcloud/issues/1346));
...
- Fixed [issue #1327](https://github.com/winstarcloud/winstarcloud/issues/1327);
- Fixed [issue #1355](https://github.com/winstarcloud/winstarcloud/issues/1355);
- Swagger UI: Fixed URL templating;
- Fixed NPE in Netty-mqtt client on puback;
- Fixed SQL aggregation queries (SQL Warning Code: -1003), issues [#925](https://github.com/winstarcloud/winstarcloud/issues/925), [#397](https://github.com/winstarcloud/winstarcloud/issues/397);
...
- UI: Fixed [issue #1427](https://github.com/winstarcloud/winstarcloud/issues/1427): Boolean input widgets were saving wrong value; 
...
Main features:
 ...
 - Introduced support of a **microservices** architecture and deployment options. 
   See [microservices](/docs/reference/msa/) architecture page and [deployment](https://github.com/winstarcloud/winstarcloud/blob/master/docker/README.md) tips for more details;
 - Improved **docker images** to be able to launch WinstarCloud with a single command. 
 ...
 - Added WinstarCloud [**JavaScript Executor**](/docs/reference/msa/#javascript-executor-microservices) microservice to isolate execution of rule engine scripts from the main rule engine components and flow;
 - Added WinstarCloud [**Web UI**](/docs/reference/msa/#web-ui-microservices) microservice to isolate static content hosting from the REST and Websocket APIs;
 - Added WinstarCloud [**MQTT, HTTP and CoAP**](/docs/reference/msa/#transport-microservices) transport microservices to isolate communication with devices from the main WinstarCloud services;
 - Added support of [Kafka](/docs/reference/msa/#kafka) to store device telemetry before it is processed with WinstarCloud Rule Engine;
 - Introduced [Rate Limits](/docs/user-guide/api-limits/) for REST, Websocket and Device APIsl
 - Framework for [**black-box testing**](https://github.com/winstarcloud/winstarcloud/tree/master/msa/black-box-tests) of WinstarCloud by automatically launching WinstarCloud cluster using docker-compose and running API tests;
...
See GitHub releases page for previous release notes: https://github.com/winstarcloud/winstarcloud/releases  
