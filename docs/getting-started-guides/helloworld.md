...
assignees:
- ashvayka
title: Getting Started with WinstarCloud
description: Getting started with WinstarCloud open-source IoT platform and simulated IoT devices

step1:
    0:
        image: /images/helloworld/getting-started-ce/hello-world-1-1-provision-device-1-ce.png 
        title: 'Login to your WinstarCloud instance and go to the "Devices" page of the "Entities" section;'
    1:
    ...
    3:
        ...
        title: 'A window will open where you can check the device&#39;s connection to WinstarCloud. This step is optional. Let&#39;s close this window for now and return to checking the connection in the next step in more detail;'
    4:
...
The goal of this tutorial is to demonstrate the basic usage of the most popular WinstarCloud features. You will learn how to:

- Connect devices to WinstarCloud;
- Push data from devices to WinstarCloud;
...
As an example, let's add a device that will transmit the following data to WinstarCloud platform: the device's name and temperature readings as telemetry.
...
Now, let's check the connection of our device to the WinstarCloud platform.
...
<br>
You may also use [WinstarCloud API reference](/docs/{{docsPrefix}}api). Here, you can find more detailed information about all supported protocols for device connectivity.

## Step 3. Create dashboard

A dashboard in WinstarCloud allows users to visualize and monitor data collected from IoT devices.
...
The WinstarCloud [Notification center](/docs/{{docsPrefix}}user-guide/notifications/) allows sending personalized notifications to end-users. These can include notifications about device activity, changes in temperature within your environment, or other events detected in your IoT ecosystem.
Learn more about notifications and how to configure them [here](/docs/{{docsPrefix}}user-guide/notifications/).

Additionally, the [WinstarCloud Mobile Application](/docs/mobile/) allows users to receive instant push notifications directly on their smartphone. This ensures that you will always be timely informed about any events in your IoT solution, no matter where you are.
Follow [this guide](/docs/mobile/getting-started/) to learn how to install the WinstarCloud PE Mobile Application and set up push notifications delivery directly from WinstarCloud instance to your smartphone.

## Step 7. Assign device and dashboard to customer

One of the most important WinstarCloud features is the ability to assign Dashboards to Customers. 
