...
console.log('Connecting to: %s using access token: %s', process.env.WINSTARCLOUD_HOST, process.env.ACCESS_TOKEN);

var client  = mqtt.connect('mqtt://'+ process.env.WINSTARCLOUD_HOST,{
