...
description: OPC-UA protocol support for WinstarCloud IoT Gateway
...
This guide will help you to get familiar with OPC-UA connector configuration for WinstarCloud IoT Gateway.
    ...
    "mapping": [
      {
        ...
        "attributes_updates": [
          {
            "attributeOnWinstarCloud": "deviceName",
...
To connect your OPC-UA server to WinstarCloud, open the OPC-UA Connector configuration file (opcua.json) and replace the "url" value with the copied connection address.
...
After running **WinstarCloud IoT gateway**, you will see the new **Device OPC-UA** device in your WinstarCloud instance.
...
| **Parameter**   | **Default value**           | **Description**                                                                                       |
|:-|:-|-------------------------------------------------------------------------------------------------------
| key             | **CertificateNumber**       | Tag, that will be interpreted as attribute for the WinstarCloud platform instance.                     |
...
You should be able to see the attributes you have sent to WinstarCloud in the **Attributes** section of your device:
...
| **Parameter**   | **Default value**                                                            | **Description**                                                                                                 |
|:-|:-----------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------
| key             | **temperature °C**                                                           | Tag, that will be interpreted as telemetry for WinstarCloud platform instance.                                   |
...
You should be able to see the telemetry you have sent to WinstarCloud in the **Latest telemetry** section of your device:
...
This subsection contains configuration for RPC request from WinstarCloud platform instance.
...
This subsection contains configuration for attribute updates request from WinstarCloud platform instance.

| **Parameter**             | **Default value**                                           | **Description**                                                                              |
|:-|:------------------------------------------------------------|----------------------------------------------------------------------------------------------
| attributeOnWinstarCloud    | **deviceName**                                              | Name of a server side argument.                                                              |
...
Go to **"Shared attributes"** and create a new one for your device in the WinstarCloud instance.
...
Explore guides related to main WinstarCloud features:
 ...
 - [WinstarCloud IoT Gateway Features](/docs/iot-gateway/features/)
