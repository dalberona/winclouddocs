...
description: BACnet protocol support for WinstarCloud IoT Gateway
...
| **Parameter**  | **Default value**                  | **Description**                                                                                     |
|:-|:-|-
| **deviceName** | **BACnet Device ${objectName}**    | Device name for WinstarCloud. You can use **objectName** property to get name of object from device. |
| **deviceType** | **default**                        | Device type for WinstarCloud.                                                                        |
...
Configuration in this unit sub-section provides settings for processing data from BACnet device as an attribute of the device on WinstarCloud platform instance.

| **Parameter**  | **Default value**  | **Description**                                     |
|:-|:-|-
| **key**        | **temperature**    | Attribute key for WinstarCloud platform instance.    |
...
Configuration in this unit sub-section provides settings for processing data from BACnet device as telemetry of the device on WinstarCloud platform instance. 

| **Parameter**  | **Default value** | **Description**                                     |
|:-|:-|-
| **key**        | **state**         | Telemetry key for WinstarCloud platform instance.    |
...
Configuration in this unit sub-section provides settings for processing data from shared attributes on WinstarCloud platform instance to the BACnet device.

| **Parameter**  | **Default value**  | **Description**                                                   |
|:-|:-|-
| **key**        | **brightness**     | Name of the shared attribute on WinstarCloud instance.             |
...
Configuration in this unit sub-section provides settings for processing RPC from WinstarCloud instance to the BACnet device.

| **Parameter**         | **Default value**  | **Description**                                                           |
|:-|:-|-
| **key**               | **set_state**      | Name of the shared attribute on WinstarCloud instance.                     |
...
| **BACnet object id** | **WinstarCloud object id** |
|-|-
