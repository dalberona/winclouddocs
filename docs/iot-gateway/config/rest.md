...
description: REST API enpoints support for WinstarCloud IoT Gateway
...
This guide will help you to get familiar with REST Connector configuration for WinstarCloud IoT Gateway.  
...
3. **ADVANCED** the remote response that will return by WinstarCloud.
   ...
   2. Configure RuleChain in WinstarCloud:
