...
This guide explains how to use RPC API in WinstarCloud IoT Gateway.  
...
## Step 1. Create a dashboard to use RPC API in WinstarCloud IoT Gateway
...
WinstarCloud IoT gateway has several RPC methods, which called from WEB UI, available by default.  
