...
title: IoT Gateway
description: WinstarCloud IoT Gateway to connect existing and legacy IoT devices to the platform

---

The WinstarCloud **IoT Gateway** will help you to integrate devices that are connected to legacy and third-party systems with WinstarCloud IoT platform.
...
<div class="doc-features row mt-4">
    <div class="col-12 col-sm-6 col-lg col-xxl-6 col-4xl mb-4">
        <a class="feature-card" href="/docs/iot-gateway/what-is-iot-gateway/">
            ...
            <div class="feature-title">What is WinstarCloud IoT Gateway?</div>
    ...
    <div class="col-12 col-sm-6 col-lg col-xxl-6 col-4xl mb-4">
        <a class="feature-card" href="/docs/iot-gateway/installation/">
            ...
            <div class="feature-text">
                Learn how to install and upgrade WinstarCloud IoT Gateway.
            </div>
        </a>
    </div>
    <div class="col-12 col-sm-6 col-lg col-xxl-6 col-4xl mb-4">
