       ...
       <div class="install-options-hero">
          <div class="container">
            <div class="install-options-hero-content">
                <h1>WinstarCloud IoT Gateway installation options</h1>
                <div class="install-options-description">
                    <p>
                        WinstarCloud IoT Gateway is designed to run and utilize on majority of hardware, from single-board computers like Raspberry Pi to powerful Edge Gateways for IoT
                    </p>
                </div>
            </div>
