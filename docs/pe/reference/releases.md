...
title: WinstarCloud PE Release Notes
...
Everything from [TB CE v3.7](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.7) with the following improvements and bug fixes.
...
Everything from [TB CE v3.6.4](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.6.4) with the following improvements and bug fixes.
...
Everything from [TB CE v3.6.3](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.6.3) with the following improvements and bug fixes.
...
Everything from [TB CE v3.6.2](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.6.2) with the following improvements and bug fixes.
...
Everything from [TB CE v3.6.1](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.6.1) with the following improvements and bug fixes.
...
Everything from [TB CE v3.6](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.6) with the following improvements and bug fixes.
...
Everything from [TB CE v3.5.1](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.5.1) with the following bug fixes.
...
Everything from [TB CE v3.5](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.5) with the following features and bug fixes.
...
Everything from [TB CE v3.4.4](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.4.4) with the following bug fixes.
...
Everything from [TB CE v3.4.3](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.4.3) with the following improvements and bug fixes.
...
Everything from [TB CE v3.4.2](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.4.2) with the following improvements and bug fixes.
...
* Core:
  * [#7415](https://github.com/winstarcloud/winstarcloud/issues/7415) Fixed Entity Group Name filter;
  * [#7225](https://github.com/winstarcloud/winstarcloud/issues/7225) Fixed Scheduler timezone gap;
...
Everything from [TB CE v3.4.1](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.4.1) with the following improvements and bug fixes.
...
Everything from [TB CE v3.4](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.4) with the following improvements and bug fixes.
...
Everything from [TB CE v3.3.4](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.3.4) with the following improvements and bug fixes.
...
Everything from [TB CE v3.3.3](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.3.3) with the following improvements.
...
Everything from [TB CE v3.3.2](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.3.2) with the following improvements.
...
Everything from [TB CE v3.3.1](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.3.1) with the following improvements.
...
Everything from [TB CE v3.3](https://github.com/winstarcloud/winstarcloud/releases/tag/v3.3) with the following improvements.
