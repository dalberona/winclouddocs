...
WINSTARCLOUD_EDGE_HOST = YOUR_TB_EDGE_HOST # REPLACE with your WinstarCloud Edge server installation IP address or hostname, e.g. 'localhost'
WINSTARCLOUD_EDGE_MQTT_PORT = YOUR_TB_EDGE_MQTT_PORT # REPLACE with your WinstarCloud Edge MQTT port, e.g. 11883 or 1883
DISTANCE = 0
...
while(True):
    ...
    # Connect to WinstarCloud using default MQTT port and 60 seconds keep alive
    client.connect(WINSTARCLOUD_EDGE_HOST, WINSTARCLOUD_EDGE_MQTT_PORT, 60)
    try:
