...
assignIntegration:
    ...
    2:
        ...
        title: 'Login to your <b>WinstarCloud Edge</b> instance and open Integrations page'
...
- WinstarCloud PE Edge;
- TCP Integration, running externally and connected to the cloud WinstarCloud Edge instance;
...
An example of sent message and a response from WinstarCloud Edge in the terminal:
