...
title: Configure Self-registration in WinstarCloud PE Mobile Application
...
WinstarCloud PE Mobile Application provides self-registration support. The mobile app with self-registration enabled provides a registration form allowing to sign up new customer users.
...
Open **flutter_winstarcloud_pe_app** project in your editor/IDE. Edit **lib/constants/app_constants.dart**.

Set value of **winstarcloudSignUpAppSecret** constant to value of **Application secret** field:

```dart
abstract class WinstarcloudAppConstants {
  ...

  static final winstarcloudSignUpAppSecret = 'Your sign up app secret here';
}
