...
supervisors-add-new-user:
    ...
    3:
        ...
        title: 'Click on the "+" sign at the top right of the screen. Input email address, for instance, we can use janesmith@winstarcloud.io, and click "Add";'
    4:
...
supervisors-create-read-only-user:
    ...
    1:
        ...
        title: 'Click "+" at the top right of the screen to add new user. Input email address, for example, we will use bob@winstarcloud.io, then click "Add";'
    2:
