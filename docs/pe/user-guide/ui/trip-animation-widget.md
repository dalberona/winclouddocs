...
create-dashboard-1:
    0:
        ...
        title: 'Login to your WinstarCloud instance and navigate to the "Dashboards" page through the main menu on the left of the screen. By default, you will be redirected to the "All" device group;'
    1:
