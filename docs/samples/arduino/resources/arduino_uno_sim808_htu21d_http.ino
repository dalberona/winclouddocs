...
// using WinstarCloud SDK and GSM modem, such as SIM808
//
// Hardware:
//  - Arduino Uno
...
WinstarCloudHttp tb(client, TOKEN, WINSTARCLOUD_SERVER, WINSTARCLOUD_PORT);
...
void loop() {
  ...
  // Uploads new telemetry to WinstarCloud using HTTP.
  // See https://winstarcloud.io/docs/reference/http-api/#telemetry-upload-api
  // for more details
