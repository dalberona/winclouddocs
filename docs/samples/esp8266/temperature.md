...
description: WinstarCloud IoT Platform sample for temperature data upload over MQTT using ESP8266 and DHT22 sensor.
...
ESP8266 push data to WinstarCloud server via MQTT protocol by using [PubSubClient](https://github.com/knolleary/pubsubclient) library for Arduino.
