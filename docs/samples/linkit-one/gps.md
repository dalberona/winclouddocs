---
layout: docwithnav
title: GPS data upload and visualization using LinkIt ONE and WinstarCloud
description: WinstarCloud IoT Platform sample for GPS data upload and visualization using LinkIt ONE
...
The purpose of this application is to demonstrate WinstarCloud data collection API and visualization capabilities.

The GPS module is a built-in module of [LinkIt ONE](https://wiki.seeedstudio.com/LinkIt_ONE/). 
LinkIt ONE pushes data to WinstarCloud server via MQTT protocol by using [PubSubClient](https://github.com/knolleary/pubsubclient) library for Arduino.
...
**Note** You need to edit following constants and variables in the sketch:
 ...
 - winstarcloudServer - WinstarCloud HOST/IP address that is accessible within your wifi network. Specify "demo.winstarcloud.io" if you are using [live demo](https://demo.winstarcloud.io/) server.
...
After application will be uploaded and started it will try to connect to WinstarCloud node using mqtt client and upload "latitude" and "longitude" attributes once per second.
