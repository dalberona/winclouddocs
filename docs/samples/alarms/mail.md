...
We will use [Live Demo](https://demo.winstarcloud.io) Thignsboard server and [SendGrid](http://www.sendgrid.com) SMTP API in this tutorial. 
...
Login to [Live Demo](https://demo.winstarcloud.io) server using Tenant Administrator account (the one that you created during sign-up).
