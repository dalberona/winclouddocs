...
This guide provides step-by-step instructions for connecting the Abeeway Micro Tracker and Abeeway Industrial Tracker to WinstarCloud Professional Edition (PE).
...
In this guide, we will use the free WinstarCloud PE demo server [winstarcloud.cloud](https://winstarcloud.cloud/signup) in this guide.
...
- We also assume you already have a WinstarCloud PE server or free demo account.
Otherwise, you can register for a 30-days free demo account here: [winstarcloud.cloud](https://winstarcloud.cloud/signup).
We expect you to have at least a basic knowledge about WinstarCloud, so we do recommend to complete the [Getting Started](/docs/getting-started-guides/helloworld) guide.


## Integration overview

WinstarCloud Platform Integrations feature allows to push data from various platforms and connectivity solutions to WinstarCloud.
We will use platform ThingPark Wireless company Actility to consume data from LoRaWAN networks and automatically register devices in WinstarCloud.
Besides configuring the integration, we will also set WinstarCloud up to decode incoming data, store it in the database, visualize on the dashboard and generate alarms based on configurable thresholds.
...
The <b>DevEUI</b> from the incoming message will become the Device <b>Name</b> in WinstarCloud;

WinstarCloud will automatically create device with type “tracker” and name equal to <b>DevEUI</b>;
...
The converters will decode incoming telemetry payload data from global standard LoRaWAN that contains in encoded hex string to human readable, simplified WinstarCloud data format.
...
<details>
    <summary>
        <font color="#006400"><i><b>Screenshot of creating integration on the WinstarCloud platform</b></i></font> <br> (<b>click to open expanded view</b>)
    </summary> 
...
After creating and configuring the integration and connecting it to platform ThingPark Wireless company Actility, WinstarCloud will begin receiving the first reports of the telemetry from your devices.
<details>
   <summary>
...
On the basis of these first messages WinstarCloud system will automatically create devices with type  and name  under which devices were registered in the ThingPark Actility Enterprise.
<details>
   <summary>
       <font color="#006400"><i><b>Screenshot of how WinstarCloud system will automatically create devices</b></i></font> (<b>click to open expanded view</b>)
   </summary>
   <img src="/images/samples/abeeway/after_integr_dev.png" alt="After integr dev screen">
</details>
That's why after creating and configuring the integration and before starting the Dashboard setup you need to check that all your devices are detected and visible in WinstarCloud.
...
<details>
    ...
    <ul>
        ...
        <details>
          <summary>
              <font color="#228b22"><i><b>Screenshot of receiving confirmation from the ThingPark Wireless to WinstarCloudabout sending a message to the device</b></i></font> (<b>click to open expanded view</b>)
          </summary>
          <img src="/images/samples/abeeway/receiving_confirmation_singboard.png" alt="Receiving confirmation thingboard dialog">
         </details>
        <details>
          <summary>
              <font color="#228b22"><i><b>Screenshot of decoding device response by Winstarcloud  UpLink decoder</b></i></font> (<b>click to open expanded view</b>)
          </summary>
