---
layout: docwithnav
title: Facilities monitoring system prototype using WinstarCloud
description: Facilities monitoring system prototype using IoT Devices and WinstarCloud
---
...
In order to demonstrate this PoC in action you need to do two simple steps:
 ...
 - [Sign-up](https://demo.winstarcloud.io/signup) or [login](https://demo.winstarcloud.io) to the live demo instance and save your login and password.
 - Download and launch device emulator using this [link](https://github.com/winstarcloud/samples/releases/download/v1.0-tfm/facilities-monitoring.jar). 

```shell
java -jar facilities-monitoring.jar demo.winstarcloud.io
```
...
This demonstrates how easy is to prototype and build IoT solutions using [WinstarCloud](http://winstarcloud.io). Of course, there is a certain learning curve that you need to pass, but we hope that this article and other [docs](http://winstarcloud.io/docs/) will help you to do this.

If you found this article interesting, please leave your feedback, questions or feature requests in the comments section and “star” our project on the [github](https://github.com/winstarcloud/winstarcloud) in order to stay tuned for new releases and tutorials.
...
## Links
 ...
 - [WinstarCloud github page](https://github.com/winstarcloud/winstarcloud)
 - [Emulator source code](https://github.com/winstarcloud/samples)
 - [Emulator binary](https://github.com/winstarcloud/samples/releases/download/v1.0-tfm/facilities-monitoring.jar)