...
5. [WinstarCloud configuration](#tb_configuration)
...
This guide contains step-by-step instructions on how to connect your Nettra RTU device to WinstarCloud Community Edition through TCP/IP via wifi, using as sample, one of the many applications that the Nettra RTU has. At the end of this guide, you will be able to monitor data using Winstarcloud web UI to display it.
...
### Software
 ...
 - You will need to have WinstarCloud server up and running. Use either [Live Demo](https://winstarcloud.io/docs/user-guide/install/installation-options/?ceInstallType=liveDemo) or [Installation Guide](https://winstarcloud.io/docs/user-guide/install/ubuntu/) to install WinstarCloud.
...
Sign up WinstarCloud Web UI as [live-demo](https://demo.winstarcloud.io/signup). See [Live Demo](https://winstarcloud.io/docs/user-guide/install/installation-options/?ceInstallType=liveDemo) page for more details how to get your account.
...
Use import/export [instructions](https://winstarcloud.io/docs/user-guide/dashboards/#import-dashboard) to import the dashboard to your WinstarCloud instance.
...
1. Go to *"Communications"*.
2. Click on *"MQTT"*.
3. On *"Interface"* select *"Modem"*. On *"Format"* select *"Winstarcloud"*. On *"URI"* paste *"mqtt://demo.winstarcloud.io:1883"*. On *"Password"* paste the Device Acces Token from *"Device"* step.
...
/*
 * DESCRIPTION :
 *	- Sending a variable to a Winstarcloud Dashboard
*/
...
Browse other [samples](https://winstarcloud.io/docs/samples/) or explore guides related to main WinstarCloud features:

 - [Device attributes](https://winstarcloud.io/docs/user-guide/attributes/) - how to use device attributes.
 - [Data Visualization](https://winstarcloud.io/docs/guides/#AnchorIDDataVisualization) - how to visualize collected data.
 - [Data Analytics](https://winstarcloud.io/docs/guides/#AnchorIDDataAnalytics) - how to collect telemetry data.
 - [Rule Engine](https://winstarcloud.io/docs/user-guide/rule-engine-2-0/re-getting-started/) - how to use rule engine to analyze data from devices.
 - [Using RPC capabilities](https://winstarcloud.io/docs/user-guide/rule-engine-2-0/tutorials/rpc-request-tutorial/) - how to send commands to/from devices.
