...
In this guide we will describe how to connect standard WinstarCloud widgets located on the dashboard with Trendz View. 
You can do this using WinstarCloud dashboard aliases and **Trendz View - with filter alias** from **Trendz widget Bundle**.

**Example**: we have 10 **Machine** devices in WinstarCloud. We want to create a dashboard that will show all **Machine** devices 
...
On WinstarCloud side we setup a dashboard and add 2 widgets. Detailed instruction how to do this is not part of this tutorial, 
...
Return to WinstarCloud Dashboard:
* Edit dashboard
