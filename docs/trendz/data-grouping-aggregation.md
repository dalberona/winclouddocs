...
Trendz will find all available buildings in the WinstarCloud, then all Apartments for each Building and finally all Energy Meters that belong to the apartment.
