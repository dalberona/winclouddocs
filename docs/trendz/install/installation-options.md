...
assignees:
  - vparomskiy
title: WinstarCloud Trendz Analytics installation options
description: WinstarCloud Trendz Analytics installation instructions for various operation systems
notitle: "true"
---
       ...
       <div class="install-options-hero">
          <div class="container">
            <div class="install-options-hero-content">
                <h1>WinstarCloud Trendz Analytics installation options</h1>
            </div>
