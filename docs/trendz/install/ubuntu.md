...
assignees:
- ashvayka
title: Installing WinstarCloud Trendz Analytics on Ubuntu
description: Installing WinstarCloud Trendz Analytics on Ubuntu
...
```bash
wget https://dist.winstarcloud.io/trendz-{{ site.release.trendz_ver }}.deb
```
{: .copy-code}
