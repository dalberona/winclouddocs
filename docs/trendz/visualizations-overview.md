...
At this moment you will see average measurement from all entities in the WinstarCloud

* Add **Entity Name** to the **Series** section - separate series displayed for each entity

## Video Tutorial

We are glad to present the series of webinars about WinstarCloud Trendz Analytics functionality. 
