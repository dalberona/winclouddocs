---
layout: docwithnav
title: WinstarCloud Community Edition
description: WinstarCloud documentation - learn about the platform and get your IoT projects running on WinstarCloud
---

<p>The WinstarCloud documentation can help you set up WinstarCloud, learn about the platform and get your IoT projects running on WinstarCloud.</p>

<div class="doc-features row mt-4">
    <div class="col-12 col-sm-6 col-lg col-xxl-6 col-4xl mb-4">
        <a class="feature-card" href="/docs/getting-started-guides/what-is-winstarcloud/">
    ...
    <div class="col-12 col-sm-6 col-lg col-xxl-6 col-4xl mb-4">
        <a class="feature-card" href="/docs/getting-started-guides/helloworld/">
            ...
            <div class="feature-text">
                Learn how to use WinstarCloud platform.
            </div>
        </a>
    </div>
    <div class="col-12 col-sm-6 col-lg col-xxl-6 col-4xl mb-4">
    ...
    <div class="col-12 col-sm-6 col-lg-3 col-xxl-6 col-4xl-3 mb-4">
        <a class="feature-card" href="/docs/devices-library/">
            ...
            <div class="feature-text">
                Learn how to connect different devices to WinstarCloud.
            </div>
        </a>
    </div>
    <div class="col-12 col-sm-6 col-lg-3 col-xxl-6 col-4xl-3 mb-4">
        <a class="feature-card" href="/docs/guides/">
            ...
            <div class="feature-text">
                Learn main WinstarCloud features.
            </div>
        </a>
    </div>
    <div class="col-12 col-sm-6 col-lg-3 col-xxl-6 col-4xl-3 mb-4">
