...
The WinstarCloud Youtube [channel](https://www.youtube.com/channel/UCDb9fsV-YR4JmnipAMGsVAQ/videos) provides useful video tutorials covering various features of the WinstarCloud platform.
...
This video tutorial will give you a brief introduction to the WinstarCloud platform and a hands-on part to help you to get started. 
...
#### Device data management using WinstarCloud
...
#### Temperature upload from ESP8266 and DHT22 using Winstarcloud

This video tutorial shows a demo about how to upload the temperature and humidity data from ESP8266 and DHT22 over MQTT using Arduino SDK and Winstarcloud.  
...
Related Links: <a href="https://blog.winstarcloud.io/2016/12/temperature-upload-over-mqtt-using_21.html">Tutorial Documentation

#### ESP8266 GPIO control using Winstarcloud

This video tutorial showsa demo about how to control ESP8266 GPIO over MQTT using Arduino SDK and Winstarcloud 
...
Related Links: <a href="https://blog.winstarcloud.io/2017/01/esp8266-gpio-control-over-mqtt-using.html">Tutorial documentation

#### Temperature upload from Raspberry Pi and DHT22 using Winstarcloud

This video tutorial shows a demo about how to upload the temperature and humidity data from Raspberry Pi and DHT22 over MQTT using Python and Winstarcloud 
...
Related Links: <a href="https://blog.winstarcloud.io/2017/01/temperature-upload-over-mqtt-using.html">Tutorial documentation

#### Raspberry Pi GPIO control using Winstarcloud
This video tutorial shows a demo about how to contro Raspberry Pi GPIO over MQTT using Python and Winstarcloud. 
For more details and source code reference, please refer to the tutorial documentation in the related links. 
...
Related Links:<br>
<a href="https://blog.winstarcloud.io/2016/12/raspberry-pi-gpio-control-over-mqtt.html">Raspberry Pi GPIO control over MQTT using Python and Winstarcloud Tutorial documentation
<br>
<a href="https://blog.winstarcloud.io/2017/01/raspberry-pi-gpio-control-using-android.html">Raspberry Pi GPIO control using Android Things and Winstarcloud tutorial documentation
...
## WinstarCloud Professional Edition (PE) Features 

#### WinstarCloud PE: White Labeling Guide
WinstarCloud Professional Edition web interface allows you to configure your company or product logo and color scheme in 2 minutes with zero coding efforts and no service restart required. 
...
#### WinstarCloud PE: CSV/XLS data export
In this video tutorial, you will see how WinstarCloud Professional Edition allows you to export data from widgets to CSV or XLS. This functionality is available almost in any widget if it is applicable to the widget type. The list of columns in the exported data set corresponds to the list of parameters you configure in the data set configuration. 
...
#### WinstarCloud PE: AWS IoT Integration Configuration Guide

AWS IoT Integration allows to stream data from AWS IoT Backend to WinstarCloud Professional Edition and converts device payloads to the WinstarCloud format. This video tutorial will show you how to configure AWS IoT Integration.
...
####  WinstarCloud PE: Data Converters Configuration Guide

Data Converters are a part of the Platform Integration feature. WinstarCloud uses two types of data converters:

 - Uplink data converters: to parse the payload of the incoming message and transform it to the same format used by WinstarCloud. 
...
#### WinstarCloud PE: SigFox Integration Configuration Guide
Sigfox Integration allows to stream data from Sigfox Backend to WinstarCloud Professional Edition and converts binary device payloads to the WinstarCloud format. This video tutorial will show you how to configure SigFox Integration
...
#### WinstarCloud PE: HTTP Integration Configuration Guide 
WinstarCloud Professional Edition HTTP Integration allows to convert existing protocols and payload formats to WinstarCloud message format and it is useful in several deployment scenarios, such as: 

 - stream device and/or asset data from an external system, IoT platform or connectivity provider backend.
 - stream device and/or asset data from your custom application running in the cloud.
 - connect the existing device that uses a custom HTTP-based protocol to WinstarCloud. 
...
#### WinstarCloud PE: IBM Watson IoT Integration Configuration Guide 
IBM Watson IoT Integration allows to stream data from IBM Watson IoT to WinstarCloud Professional Edition and converts device payloads to the WinstarCloud format. This video tutorial will show you how to configure IBM Wastson Integration

You will learn how to:

 - prepare the IBM Watson platform for integration with WinstarCloud 
...
#### WinstarCloud PE: Azure Event Hub Integration Configuration Guide
Azure Event Hub Integration allows to stream data from Azure Event Hub to WinstarCloud Professional Edition and converts device payloads to the WinstarCloud format. This video tutorial will show you how to configure Azure Event Hub Integration.

You will learn how to:

 - prepare the Azure Event Hub platform for integration with WinstarCloud 
...
#### WinstarCloud PE: MQTT Integration Configuration Guide
WinstarCloud Professional Edition MQTT Integration allows to convert existing protocols and payload formats to WinstarCloud message format and it is useful in several deployment scenarios, such as: 

- stream device and/or asset data from an external system, IoT platform or connectivity provider backend.
- stream device and/or asset data from your custom application running in the cloud.
- connect the existing device that uses a custom MQTT-based protocol to WinstarCloud.
