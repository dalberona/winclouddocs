...
creating-dashboard:
    0:
        ...
        title: 'Login to your WinstarCloud instance and navigate to the "Dashboards" page through the main menu on the left of the screen. By default, you navigate to the dashboard group "All";'
    1:
