...
server:
    0:
        image: /images/user-guide/integrations/loriot/loriot_and_winstarcloud_integration_server_1.png

downlink_server:
    0:
        image: /images/user-guide/integrations/loriot/loriot_and_winstarcloud_integration_server.png
...
application_id:
    0:
        image: /images/user-guide/integrations/loriot/loriot_and_winstarcloud_integration_application_id_1.png 

downlink_applications:
    0:
        image: /images/user-guide/integrations/loriot/loriot_applications.png
    1:
        image: /images/user-guide/integrations/loriot/loriot_and_winstarcloud_integration_application_id.png
...
access_token:
    ...
    2:
        image: /images/user-guide/integrations/loriot/loriot_and_winstarcloud_integration_application_access_token.png
...
send_downlink:
    0:
        image: /images/user-guide/integrations/loriot/winstarcloud_add_integration_send_downlink.png
...
basic:
    0:
        image: /images/user-guide/integrations/loriot/winstarcloud_add_integration_output_basic.png
    1:
        image: /images/user-guide/integrations/loriot/winstarcloud_add_integration_output_basic_email_and_password.png

security_token:
    0:
        image: /images/user-guide/integrations/loriot/winstarcloud_add_integration_output_security_token.png
    1:
        image: /images/user-guide/integrations/loriot/loriot_and_winstarcloud_output_security_token_session.png

rule_chain:
    0:
        image: /images/user-guide/integrations/loriot/winstarcloud_rule_chain_integration_downlink.png

shared_attributes:
    0:
        image: /images/user-guide/integrations/loriot/winstarcloud_devices_all_shared_attributes.png
    1:
        image: /images/user-guide/integrations/loriot/winstarcloud_devices_all_shared_attributes_update.png

event_in:
    0:
        image: /images/user-guide/integrations/loriot/winstarcloud_downlink_converter_events_in.png

event_out:
    0:
        image: /images/user-guide/integrations/loriot/winstarcloud_downlink_converter_events_out.png
...
device_groups:
    0:
        image: /images/user-guide/integrations/loriot/winstarcloud_devices_all_attributes.png

uplink_events:
    0:
        image: /images/user-guide/integrations/loriot/winstarcloud_uplink_converter_events_in.png
    1:
        image: /images/user-guide/integrations/loriot/winstarcloud_uplink_converter_events_out.png
