...
def collect_required_data():
    config = {}
    print("\n\n", "="*80, sep="")
    print(" "*20, "\033[1m\033[94mWinstarCloud one way RPC example script.\033[0m", sep="")
    print("="*80, "\n\n", sep="")
    host = input("Please write your WinstarCloud \033[93mhost\033[0m or leave it blank to use default (localhost): ")
