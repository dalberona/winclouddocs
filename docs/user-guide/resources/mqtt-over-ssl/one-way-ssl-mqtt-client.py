#
# Copyright © 2016-2020 The Winstarcloud Authors
#
...
def collect_required_data():
    config = {}
    print("\n\n", "=" * 80, sep="")
    print(" " * 20, "WinstarCloud one way RPC example script.", sep="")
    print("=" * 80, "\n\n", sep="")
    host = input("Please write your WinstarCloud host or leave it blank to use default (winstarcloud.cloud): ")
    config["host"] = host if host else "mqtt.winstarcloud.cloud"
    if config["host"] != "mqtt.winstarcloud.cloud":
        ca_cert = input(
