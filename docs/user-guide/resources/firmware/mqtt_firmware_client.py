...
def collect_required_data():
    config = {}
    print("\n\n", "="*80, sep="")
    print(" "*20, "WinstarCloud getting firmware example script.", sep="")
    print("="*80, "\n\n", sep="")
    host = input("Please write your WinstarCloud host or leave it blank to use default (localhost): ")
    config["host"] = host if host else "localhost"
    host = input("Please write your WinstarCloud port or leave it blank to use default (1883): ")
