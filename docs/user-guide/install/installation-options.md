...
assignees:
- ashvayka
title: WinstarCloud installation options
       ...
       <div class="install-options-hero">
          <div class="container">
            <div class="install-options-hero-content">
                <h1>WinstarCloud installation options</h1>
                <div class="install-options-description">
                    <p>
                        WinstarCloud is designed to run and utilize on majority of hardware, from local Raspberry PI to powerful servers in the cloud
                    </p>
                </div>
            </div>
                            ...
                            <div class="deployment-cards">
                                <div class="deployment-cards-container">
                                    <div class="deployment-card-block">
                                        <a href="https://demo.winstarcloud.io/signup">
                                            <span>
