---
layout: docwithnav
title: Install HAProxy Load Balancer for WinstarCloud on CentOS/RHEL
description: Install HAProxy Load Balancer for WinstarCloud on CentOS/RHEL
hidetoc: "true"
---

This guide describes how to install HAProxy with Let's Encrypt
as a service. This is possible in case you are hosting WinstarCloud in the cloud and have a valid DNS name assigned to your instance.
...
### Step 1. Connect to your WinstarCloud instance over SSH
