...
title: Installing WinstarCloud PE from AWS Marketplace
description: Installing WinstarCloud PE from AWS Marketplace
redirect_from: "/docs/user-guide/install/aws-marketplace-pe/"
---

This guide describes how to install WinstarCloud Professional Edition from AWS Marketplace. 
...
Basically, you get the license directly from WinstarCloud, Inc, but purchase corresponding server instances and infrastructure from AWS.       
...
Open [WinstarCloud Professional Edition BYOL](https://aws.amazon.com/marketplace/pp/B07V8S6JLG) product page on [AWS Marketplace](https://aws.amazon.com/marketplace).
...
### Step 3. Launch your WinstarCloud PE instance 
...
#### Step 3.5. Launch your WinstarCloud PE Instance
...
Customer may still use <a href="https://winstarcloud.cloud" target="blank">WinstarCloud Cloud</a> for that. 
...
<p>Example A: The price for WinstarCloud PE instance with Maker subscription plan based on t2.micro with 20 GB disk will cost approximately $20.5 per month:</p>
<ul>
    <li>$10.00 for monthly WinstarCloud PE Maker subscription fee</li>
    <li>$8.468 for 1 month of t2.micro usage</li>
    <li>$2.0 for 20 GB of EBS volume per month</li>
</ul>
<p>Example B: The price for WinstarCloud PE instance with Prototype subscription plan based on t2.medium with 100 GB disk will cost approximately $142.872 per month:</p>
<ul>
    <li>$99.00  for monthly WinstarCloud PE Prototype subscription fee</li>
...
**How to connect to my new WinstarCloud PE instance using SSH?**
...
**How to connect to my new WinstarCloud PE instance using PuTTY?**
...
**Where is my WinstarCloud instance logs?**
