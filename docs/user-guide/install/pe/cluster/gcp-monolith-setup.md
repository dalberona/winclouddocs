...
This guide will help you to set up WinstarCloud in monolith mode using [Google Kubernetes Engine](https://cloud.google.com/kubernetes-engine). 
...
cd winstarcloud-pe-k8s/gcp/monolith
```
{: .copy-code}
