...
Download WinstarCloud PE installation package for Windows: [winstarcloud-windows-setup-3.2pe.exe](https://dist.winstarcloud.io/winstarcloud-windows-setup-3.2pe.exe).
...
Download WinstarCloud PE installation package for Windows: [winstarcloud-windows-setup-3.3.2pe.exe](https://dist.winstarcloud.io/winstarcloud-windows-setup-3.3.2pe.exe).
...
winstarcloud-download-3-3-4-ubuntu,Ubuntu,shell,resources/3.3.4pe/winstarcloud-ubuntu-download.sh,/docs/user-guide/install/resources/3.3.4pe/winstarcloud-ubuntu-download.sh
winstarcloud-download-3-3-4-centos,CentOS,shell,resources/3.3.4pe/winstarcloud-centos-download.sh,/docs/user-guide/install/resources/3.3.4pe/winstarcloud-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
winstarcloud-installation-3-3-4-ubuntu,Ubuntu,shell,resources/3.3.4pe/winstarcloud-ubuntu-installation.sh,/docs/user-guide/install/resources/3.3.4pe/winstarcloud-ubuntu-installation.sh
winstarcloud-installation-3-3-4-centos,CentOS,shell,resources/3.3.4pe/winstarcloud-centos-installation.sh,/docs/user-guide/install/resources/3.3.4pe/winstarcloud-centos-installation.sh{% endcapture %}
{% include tabs.html %}
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.3.3PE. In order to upgrade to 3.3.4PE you need to [**upgrade to 3.3.3PE first**](/docs/user-guide/install/pe/upgrade-instructions/#windows-333).
{% endcapture %}
{% include templates/info-banner.md content=difference %}

#### WinstarCloud PE package download

Download WinstarCloud PE installation package for Windows: [winstarcloud-windows-3.3.4pe.zip](https://dist.winstarcloud.io/winstarcloud-windows-3.3.4pe.zip).
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.3.4PE. In order to upgrade to 3.3.4.1PE you need to [**upgrade to 3.3.4PE first**](/docs/user-guide/install/pe/upgrade-instructions/#ubuntucentos-334).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
...
winstarcloud-download-3-3-4-1-ubuntu,Ubuntu,shell,resources/3.3.4.1pe/winstarcloud-ubuntu-download.sh,/docs/user-guide/install/resources/3.3.4.1pe/winstarcloud-ubuntu-download.sh
winstarcloud-download-3-3-4-1-centos,CentOS,shell,resources/3.3.4.1pe/winstarcloud-centos-download.sh,/docs/user-guide/install/resources/3.3.4.1pe/winstarcloud-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
winstarcloud-installation-3-3-4-1-ubuntu,Ubuntu,shell,resources/3.3.4.1pe/winstarcloud-ubuntu-installation.sh,/docs/user-guide/install/resources/3.3.4.1pe/winstarcloud-ubuntu-installation.sh
winstarcloud-installation-3-3-4-1-centos,CentOS,shell,resources/3.3.4.1pe/winstarcloud-centos-installation.sh,/docs/user-guide/install/resources/3.3.4.1pe/winstarcloud-centos-installation.sh{% endcapture %}
{% include tabs.html %}
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.3.4PE. In order to upgrade to 3.3.4.1PE you need to [**upgrade to 3.3.4PE first**](/docs/user-guide/install/pe/upgrade-instructions/#windows-334).
{% endcapture %}
{% include templates/info-banner.md content=difference %}

#### WinstarCloud PE package download

Download WinstarCloud PE installation package for Windows: [winstarcloud-windows-3.3.4.1pe.zip](https://dist.winstarcloud.io/winstarcloud-windows-3.3.4.1pe.zip).
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.3.4.1PE. In order to upgrade to 3.4PE you need to [**upgrade to 3.3.4.1PE first**](/docs/user-guide/install/pe/upgrade-instructions/#ubuntucentos-3341).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
...
winstarcloud-download-3-4-ubuntu,Ubuntu,shell,resources/3.4pe/winstarcloud-ubuntu-download.sh,/docs/user-guide/install/resources/3.4pe/winstarcloud-ubuntu-download.sh
winstarcloud-download-3-4-centos,CentOS,shell,resources/3.4pe/winstarcloud-centos-download.sh,/docs/user-guide/install/resources/3.4pe/winstarcloud-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
winstarcloud-installation-3-4-ubuntu,Ubuntu,shell,resources/3.4pe/winstarcloud-ubuntu-installation.sh,/docs/user-guide/install/resources/3.4pe/winstarcloud-ubuntu-installation.sh
winstarcloud-installation-3-4-centos,CentOS,shell,resources/3.4pe/winstarcloud-centos-installation.sh,/docs/user-guide/install/resources/3.4pe/winstarcloud-centos-installation.sh{% endcapture %}
{% include tabs.html %}
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.3.4.1PE. In order to upgrade to 3.4PE you need to [**upgrade to 3.3.4.1PE first**](/docs/user-guide/install/pe/upgrade-instructions/#windows-3341).
{% endcapture %}
{% include templates/info-banner.md content=difference %}

#### WinstarCloud PE package download

Download WinstarCloud PE installation package for Windows: [winstarcloud-windows-setup-3.4pe.exe](https://dist.winstarcloud.io/winstarcloud-windows-setup-3.4pe.exe).
...
* Make a backup of previous WinstarCloud PE configuration located in \<WinstarCloud install dir\>\conf (for ex. C:\winstarcloud\conf).
* Run installation package **winstarcloud-windows-setup-3.4pe.exe**.
* Compare and merge your old WinstarCloud configuration files (from the backup you made in the first step) with new ones.
* Finally, run **upgrade.bat** script to upgrade WinstarCloud to the new version.
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.4PE. In order to upgrade to 3.4.1PE you need to [**upgrade to 3.4PE first**](/docs/user-guide/install/pe/upgrade-instructions/#ubuntucentos-34).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
...
winstarcloud-download-3-4-1-ubuntu,Ubuntu,shell,resources/3.4.1pe/winstarcloud-ubuntu-download.sh,/docs/user-guide/install/resources/3.4.1pe/winstarcloud-ubuntu-download.sh
winstarcloud-download-3-4-1-centos,CentOS,shell,resources/3.4.1pe/winstarcloud-centos-download.sh,/docs/user-guide/install/resources/3.4.1pe/winstarcloud-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
winstarcloud-installation-3-4-1-ubuntu,Ubuntu,shell,resources/3.4.1pe/winstarcloud-ubuntu-installation.sh,/docs/user-guide/install/resources/3.4.1pe/winstarcloud-ubuntu-installation.sh
winstarcloud-installation-3-4-1-centos,CentOS,shell,resources/3.4.1pe/winstarcloud-centos-installation.sh,/docs/user-guide/install/resources/3.4.1pe/winstarcloud-centos-installation.sh{% endcapture %}
{% include tabs.html %}
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.4PE. In order to upgrade to 3.4.1PE you need to [**upgrade to 3.4PE first**](/docs/user-guide/install/pe/upgrade-instructions/#windows-34).
{% endcapture %}
{% include templates/info-banner.md content=difference %}

#### WinstarCloud PE package download

Download WinstarCloud PE installation package for Windows: [winstarcloud-windows-setup-3.4.1pe.exe](https://dist.winstarcloud.io/winstarcloud-windows-setup-3.4.1pe.exe).
...
* Make a backup of previous WinstarCloud PE configuration located in \<WinstarCloud install dir\>\conf (for ex. C:\winstarcloud\conf).
* Run installation package **winstarcloud-windows-setup-3.4.1pe.exe**.
* Compare and merge your old WinstarCloud configuration files (from the backup you made in the first step) with new ones.
* Finally, run **upgrade.bat** script to upgrade WinstarCloud to the new version.
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.4.1PE. In order to upgrade to 3.4.2PE you need to [**upgrade to 3.4.1PE first**](/docs/user-guide/install/pe/upgrade-instructions/#ubuntucentos-341).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
...
winstarcloud-download-3-4-2-ubuntu,Ubuntu,shell,resources/3.4.2pe/winstarcloud-ubuntu-download.sh,/docs/user-guide/install/resources/3.4.2pe/winstarcloud-ubuntu-download.sh
winstarcloud-download-3-4-2-centos,CentOS,shell,resources/3.4.2pe/winstarcloud-centos-download.sh,/docs/user-guide/install/resources/3.4.2pe/winstarcloud-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
winstarcloud-installation-3-4-2-ubuntu,Ubuntu,shell,resources/3.4.2pe/winstarcloud-ubuntu-installation.sh,/docs/user-guide/install/resources/3.4.2pe/winstarcloud-ubuntu-installation.sh
winstarcloud-installation-3-4-2-centos,CentOS,shell,resources/3.4.2pe/winstarcloud-centos-installation.sh,/docs/user-guide/install/resources/3.4.2pe/winstarcloud-centos-installation.sh{% endcapture %}
{% include tabs.html %}
...
{% capture default-jwt %}
Update the JWT signing key if you use the default one "winstarcloudDefaultSigningKey" on production environments. See [JWT security settings](/docs/pe/user-guide/ui/jwt-security-settings/) for details.
{% endcapture %}
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.4.1PE. In order to upgrade to 3.4.2PE you need to [**upgrade to 3.4.1PE first**](/docs/user-guide/install/pe/upgrade-instructions/#windows-341).
{% endcapture %}
{% include templates/info-banner.md content=difference %}

#### WinstarCloud PE package download

Download WinstarCloud PE installation package for Windows: [winstarcloud-windows-setup-3.4.2pe.exe](https://dist.winstarcloud.io/winstarcloud-windows-setup-3.4.2pe.exe).
...
* Make a backup of previous WinstarCloud PE configuration located in \<WinstarCloud install dir\>\conf (for ex. C:\winstarcloud\conf).
* Run installation package **winstarcloud-windows-setup-3.4.2pe.exe**.
* Compare and merge your old WinstarCloud configuration files (from the backup you made in the first step) with new ones.
* Finally, run **upgrade.bat** script to upgrade WinstarCloud to the new version.
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.4.2PE. In order to upgrade to 3.4.3PE you need to [**upgrade to 3.4.2PE first**](/docs/user-guide/install/pe/upgrade-instructions/#ubuntucentos-342).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
...
winstarcloud-download-3-4-3-ubuntu,Ubuntu,shell,resources/3.4.3pe/winstarcloud-ubuntu-download.sh,/docs/user-guide/install/resources/3.4.3pe/winstarcloud-ubuntu-download.sh
winstarcloud-download-3-4-3-centos,CentOS,shell,resources/3.4.3pe/winstarcloud-centos-download.sh,/docs/user-guide/install/resources/3.4.3pe/winstarcloud-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
winstarcloud-installation-3-4-3-ubuntu,Ubuntu,shell,resources/3.4.3pe/winstarcloud-ubuntu-installation.sh,/docs/user-guide/install/resources/3.4.3pe/winstarcloud-ubuntu-installation.sh
winstarcloud-installation-3-4-3-centos,CentOS,shell,resources/3.4.3pe/winstarcloud-centos-installation.sh,/docs/user-guide/install/resources/3.4.3pe/winstarcloud-centos-installation.sh{% endcapture %}
{% include tabs.html %}
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.4.2PE. In order to upgrade to 3.4.3PE you need to [**upgrade to 3.4.2PE first**](/docs/user-guide/install/pe/upgrade-instructions/#windows-342).
{% endcapture %}
{% include templates/info-banner.md content=difference %}

#### WinstarCloud PE package download

Download WinstarCloud PE installation package for Windows: [winstarcloud-windows-setup-3.4.3pe.exe](https://dist.winstarcloud.io/winstarcloud-windows-setup-3.4.3pe.exe).
...
* Make a backup of previous WinstarCloud PE configuration located in \<WinstarCloud install dir\>\conf (for ex. C:\winstarcloud\conf).
* Run installation package **winstarcloud-windows-setup-3.4.3pe.exe**.
* Compare and merge your old WinstarCloud configuration files (from the backup you made in the first step) with new ones.
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.4.3PE. In order to upgrade to 3.4.4PE you need to [**upgrade to 3.4.3PE first**](/docs/user-guide/install/pe/upgrade-instructions/#ubuntucentos-343).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
...
winstarcloud-download-3-4-4-ubuntu,Ubuntu,shell,resources/3.4.4pe/winstarcloud-ubuntu-download.sh,/docs/user-guide/install/resources/3.4.4pe/winstarcloud-ubuntu-download.sh
winstarcloud-download-3-4-4-centos,CentOS,shell,resources/3.4.4pe/winstarcloud-centos-download.sh,/docs/user-guide/install/resources/3.4.4pe/winstarcloud-centos-download.sh{% endcapture %}
{% include tabs.html %}
...
winstarcloud-installation-3-4-4-ubuntu,Ubuntu,shell,resources/3.4.4pe/winstarcloud-ubuntu-installation.sh,/docs/user-guide/install/resources/3.4.4pe/winstarcloud-ubuntu-installation.sh
winstarcloud-installation-3-4-4-centos,CentOS,shell,resources/3.4.4pe/winstarcloud-centos-installation.sh,/docs/user-guide/install/resources/3.4.4pe/winstarcloud-centos-installation.sh{% endcapture %}
{% include tabs.html %}
...
**NOTE:**
<br>
These upgrade steps are applicable for WinstarCloud version 3.4.3PE. In order to upgrade to 3.4.4PE you need to [**upgrade to 3.4.3PE first**](/docs/user-guide/install/pe/upgrade-instructions/#windows-343).
{% endcapture %}
{% include templates/info-banner.md content=difference %}

#### WinstarCloud PE package download

Download WinstarCloud PE installation package for Windows: [winstarcloud-windows-setup-3.4.4pe.exe](https://dist.winstarcloud.io/winstarcloud-windows-setup-3.4.4pe.exe).
...
* Make a backup of previous WinstarCloud PE configuration located in \<WinstarCloud install dir\>\conf (for ex. C:\winstarcloud\conf).
* Run installation package **winstarcloud-windows-setup-3.4.4pe.exe**.
* Compare and merge your old WinstarCloud configuration files (from the backup you made in the first step) with new ones.
