...
assignees:
- ashvayka
title: Installing WinstarCloud PE on Ubuntu
description: Installing WinstarCloud on Ubuntu
...
```bash
wget https://dist.winstarcloud.io/winstarcloud-{{ site.release.pe_ver }}.deb
```
{: .copy-code}
...
```bash
sudo dpkg -i winstarcloud-{{ site.release.pe_ver }}.deb
```
{: .copy-code}
...
```bash
wget https://dist.winstarcloud.io/tb-web-report-{{ site.release.pe_ver }}.deb
```
{: .copy-code}
