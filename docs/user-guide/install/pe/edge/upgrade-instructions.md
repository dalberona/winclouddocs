...
description: WinstarCloud PE Edge upgrade instructions

---

<ul id="markdown-toc">
    <li>
        <a href="#prepare-for-upgrading" id="markdown-toc-prepare-for-upgrading">Prepare for upgrading WinstarCloud PE Edge</a>
        <ul>
            <li>
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.6.4EDGEPE version.
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge-pe:3.7.0EDGEPE"
    environment:
...
Make sure your image is the set to tb-edge-**pe:3.7.0EDGEPE**.
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.7pe.zip](https://dist.winstarcloud.io/tb-edge-windows-3.7pe.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.6.3EDGEPE version.
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge-pe:3.6.4EDGEPE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - tb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.6.4pe.zip](https://dist.winstarcloud.io/tb-edge-windows-3.6.4pe.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.6.2EDGEPE version.
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge-pe:3.6.3EDGEPE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - tb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.6.3pe.zip](https://dist.winstarcloud.io/tb-edge-windows-3.6.3pe.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.6.1EDGEPE version.
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge-pe:3.6.2EDGEPE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - tb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.6.2pe.zip](https://dist.winstarcloud.io/tb-edge-windows-3.6.2pe.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.6.0EDGEPE version.
...
```
docker pull winstarcloud/tb-edge-pe:3.6.1EDGEPE
```
{: .copy-code}
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge-pe:3.6.1EDGEPE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - ~/.mytb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.6.1pe.zip](https://dist.winstarcloud.io/tb-edge-windows-3.6.1pe.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.5.1.1EDGEPE version.
...
```
docker pull winstarcloud/tb-edge-pe:3.6.0EDGEPE
```
{: .copy-code}
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge-pe:3.6.0EDGEPE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - ~/.mytb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.6pe.zip](https://dist.winstarcloud.io/tb-edge-windows-3.6pe.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.5.1EDGEPE version.
...
```
docker pull winstarcloud/tb-edge-pe:3.5.1.1EDGEPE
```
{: .copy-code}
...
services:
  mytbedge:
    restart: always
    image: "winstarcloud/tb-edge-pe:3.5.1.1EDGEPE"
...
```
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.5.1.1pe.zip](https://dist.winstarcloud.io/tb-edge-windows-3.5.1.1pe.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.5.0EDGEPE version.
...
```
docker pull winstarcloud/tb-edge-pe:3.5.1EDGEPE
```
{: .copy-code}
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge-pe:3.5.1EDGEPE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - ~/.mytb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.5.1pe.zip](https://dist.winstarcloud.io/tb-edge-windows-3.5.1pe.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.4.3EDGEPE version.
...
```
docker pull winstarcloud/tb-edge-pe:3.5.0EDGEPE
```
{: .copy-code}
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge-pe:3.5.0EDGEPE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - ~/.mytb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.5pe.zip](https://dist.winstarcloud.io/tb-edge-windows-3.5pe.zip).
