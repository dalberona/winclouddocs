...
assignees:
- ashvayka
title: WinstarCloud Professional Edition cluster setup guide
notitle: "true"
description: WinstarCloud Professional Edition cluster setup guide
       ...
       <div class="install-options-hero">
          <div class="container">
            <div class="install-options-hero-content">
                <h1>WinstarCloud Professional Edition Cluster setup options</h1>
                <div class="install-options-description">
                    <p>
                        WinstarCloud IoT can be bootstrapped using different tools and platforms
                    </p>
                </div>
            </div>
