---
layout: docwithnav
title: Upgrading HAProxy Load Balancer for WinstarCloud PE from AWS Marketplace
description: Upgrading HAProxy Load Balancer for WinstarCloud PE from AWS Marketplace
hidetoc: "true"
---

This guide describes how to remove dockerized version of HAProxy Load Balancer and install HAProxy with Let's Encrypt
as ubuntu service for WinstarCloud Professional Edition from AWS Marketplace.

* TOC
{:toc}

#### Connect to your WinstarCloud PE AWS instance over SSH
