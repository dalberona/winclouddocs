...
description: WinstarCloud Edge upgrade instructions

---

<ul id="markdown-toc">
    <li>
        <a href="#prepare-for-upgrading" id="markdown-toc-prepare-for-upgrading">Prepare for upgrading WinstarCloud Edge</a>
        <ul>
            <li>
...
## Prepare for upgrading WinstarCloud Edge {#prepare-for-upgrading}
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.6.4EDGE version.
...
* Stop WinstarCloud Edge service if it is running.
...
Create docker compose file for WinstarCloud Edge upgrade process:
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge:3.7.0EDGE"
    environment:
...
Modify 'main' docker compose (`docker-compose.yml`) file for WinstarCloud Edge and update version of the image:
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.7.zip](https://github.com/winstarcloud/winstarcloud-edge/releases/download/v3.7/tb-edge-windows-3.7.zip).
...
* Make a backup of previous WinstarCloud Edge configuration located in *\<WinstarCloud Edge install dir\>\conf* (for example: *C:\tb-edge\conf*).

* Extract WinstarCloud Edge package.

* Compare and merge your old WinstarCloud Edge configuration files (from the backup you made in the previous step) with new ones.

* Finally, run **upgrade.bat** script to upgrade WinstarCloud Edge to the new version.
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.6.3EDGE version.
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge:3.6.4EDGE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - tb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.6.4.zip](https://github.com/winstarcloud/winstarcloud-edge/releases/download/v3.6.4/tb-edge-windows-3.6.4.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.6.2EDGE version.
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge:3.6.3EDGE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - tb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.6.3.zip](https://github.com/winstarcloud/winstarcloud-edge/releases/download/v3.6.3/tb-edge-windows-3.6.3.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.6.1EDGE version.
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge:3.6.2EDGE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - tb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.6.2.zip](https://github.com/winstarcloud/winstarcloud-edge/releases/download/v3.6.2/tb-edge-windows-3.6.2.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.6.0EDGE version.
...
```
docker pull winstarcloud/tb-edge:3.6.1EDGE
```
{: .copy-code}
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge:3.6.1EDGE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - ~/.mytb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.6.1.zip](https://github.com/winstarcloud/winstarcloud-edge/releases/download/v3.6.1/tb-edge-windows-3.6.1.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.5.1.1EDGE version.
...
```
docker pull winstarcloud/tb-edge:3.6.0EDGE
```
{: .copy-code}
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge:3.6.0EDGE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - ~/.mytb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.6.zip](https://github.com/winstarcloud/winstarcloud-edge/releases/download/v3.6/tb-edge-windows-3.6.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.5.1EDGE version.
...
```
docker pull winstarcloud/tb-edge:3.5.1.1EDGE
```
{: .copy-code}
...
Modify docker compose (`docker-compose.yml`) file for WinstarCloud Edge and update version of the image:
...
services:
  mytbedge:
    restart: always
    image: "winstarcloud/tb-edge:3.5.1.1EDGE"
...
```
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.5.1.1.zip](https://github.com/winstarcloud/winstarcloud-edge/releases/download/v3.5.1.1/tb-edge-windows-3.5.1.1.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.5.0EDGE version.
...
```
docker pull winstarcloud/tb-edge:3.5.1EDGE
```
{: .copy-code}
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge:3.5.1EDGE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - ~/.mytb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.5.1.zip](https://github.com/winstarcloud/winstarcloud-edge/releases/download/v3.5.1/tb-edge-windows-3.5.1.zip).
...
**NOTE**: These steps are applicable for WinstarCloud Edge 3.4.3EDGE version.
...
```
docker pull winstarcloud/tb-edge:3.5.0EDGE
```
{: .copy-code}
...
services:
  mytbedge:
    restart: on-failure
    image: "winstarcloud/tb-edge:3.5.0EDGE"
    environment:
      SPRING_DATASOURCE_URL: jdbc:postgresql://postgres:5432/tb-edge
    volumes:
      - ~/.mytb-edge-data:/data
...
Download WinstarCloud Edge package for Windows: [tb-edge-windows-3.5.zip](https://github.com/winstarcloud/winstarcloud-edge/releases/download/v3.5/tb-edge-windows-3.5.zip).
