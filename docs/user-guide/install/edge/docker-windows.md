...
title: Installing WinstarCloud Edge using Docker (Windows)
description: Installing WinstarCloud Edge using Docker (Windows)
---
...
This guide will help you to install and start WinstarCloud Edge using Docker on Windows. 
...
Windows users should use docker managed volume for WinstarCloud Edge DataBase. 
