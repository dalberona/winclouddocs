...
description: WinstarCloud IoT platform monolith setup with Kubernetes in GKE
...
This guide will help you to set up WinstarCloud in monolith mode in GKE. 
...
```bash
git clone -b release-{{ site.release.ver }} https://github.com/winstarcloud/winstarcloud-сe-k8s.git
cd winstarcloud-сe-k8s/gcp/monolith
```
{: .copy-code}
