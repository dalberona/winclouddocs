...
assignees:
- ashvayka
title: Installing WinstarCloud CE on CentOS/RHEL
description: Installing WinstarCloud CE on CentOS/RHEL
...
```bash
wget https://github.com/winstarcloud/winstarcloud/releases/download/{{ site.release.ce_tag }}/winstarcloud-{{ site.release.ce_ver }}.rpm
```
{: .copy-code}
...
```bash
sudo rpm -Uvh winstarcloud-{{ site.release.ce_ver }}.rpm
```
{: .copy-code}
