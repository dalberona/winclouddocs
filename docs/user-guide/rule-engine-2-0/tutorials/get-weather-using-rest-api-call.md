...
In this tutorial we will configure WinstarCloud Rule Engine to automatically get weather information using REST API.
...
Add Asset entity in WinstarCloud. Its name is **Building A** and its type is **building**.
