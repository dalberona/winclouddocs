...
Let's assume your device is using custom sensor to collect and push temperature readings to WinstarCloud. 
...
In this tutorial we will configure WinstarCloud Rule Engine to modify temperature readings according to a formula:
