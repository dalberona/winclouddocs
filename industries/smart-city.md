...
<div class="customer-block">
    ...
    <div class="customer-content">
        ...
        <p>
            WinstarCloud platform enables us to deliver on our promise of "Rapid Prototyping and Development" of IoT solutions for our clients. Its versatile deployment and integration capabilities make it well fit for most of the use case scenarios we find in IoT markets nowadays.
        </p>
    </div>
</div>
...
<div class="customer-block">
    ...
    <div class="customer-content">
        ...
        <p>
            WinstarCloud engineers worked hand in hand with our developers to develop the MQTT-based communication protocol between the X-TELIA network and WinstarCloud, developed a beautiful custom widget for controlling the no parking signs, implemented our instance of WinstarCloud PE and provided incredible support to make sure we made it to the finish line on time.
        </p>
        <p>
            I can say that the dedication of WinstarCloud team blew me away. I look forward to building and deploying many new and exciting projects on WinstarCloud, as I know the team backing the platform is second to none in expertise and dedication.
        </p>
    </div>
</div>
...
<div class="customer-block">
    ...
    <div class="customer-content">
        ...
        <p>
            A special thank you to Winstarcloud for their professional services in helping create a dashboard in a short period of time customized to our specific requirements. They were responsive to our needs and worked diligently to resolve any issues. Work well done.
        </p>
    </div>
</div>
...
<div class="customer-block">
    ...
    <div class="customer-content">
        ...
        <p>
            WinstarCloud is the platform which fulfilled our requirements and It is easy to adapt, flexible and have the ability to present data on different widgets in an attractive way with easy access. In addition, we are thankful to the WinstarCloud team for their tremendous service and we are looking forward to making more IOT solutions with WinstarCloud in future.
        </p>
    </div>
</div>
...
<div class="customer-block">
    ...
    <div class="customer-content">
        ...
        <p>
            During our evaluation of several different IoT platforms we decided using WinstarCloud Community Edition to quickly get started with testing of our concept solutions. Since it offers an easy way to get access to data from all our sensors and supports building dashboards for visualization.
        </p>
        <p>
            However, we soon discovered that WinstarCloud also fulfilled our need to build commercial services. With increasing number of sensors, customers and requirements we have migrated to WinstarCloud Professional Edition with a lot more functionality for larger deployments and multiple customers. And we will add additional servers as our customers grow.
        </p>
    </div>
</div>
...
<div class="customer-block">
    ...
    <div class="customer-content">
        ...
        <p>
            While building the Smart City solution for OMS, a. s. we were looking for IoT platform serving as core backend for our solutions. WinstarCloud became our first clear choice. It contains necessary business functionality and support all needed technologies/protocols which we required. Later on, WinstarCloud became the heart of the upcoming solution. In any implementation of complex systems cooperation and support are crucial to success achievement. We are glad that we found stable partners in design, implementation and deployment of WinstarCloud in the Smart City solution.
        </p>
    </div>
</div>
