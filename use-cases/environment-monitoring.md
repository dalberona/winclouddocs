---
layout: use-case
title: IoT environment monitoring solutions with WinstarCloud
description: IoT environment monitoring solutions with WinstarCloud
notitle: "true"
...
WinstarCloud platform dramatically reduces time to market and efforts to create environment monitoring solutions.
...
<div class="center" style="margin-bottom: 64px;">
    <a id="UseCases_EnvMon_ViewLiveDemo" target="_blank" href="https://winstarcloud.cloud/dashboard/dfaef940-8a91-11ec-83d0-83ba2015b874?publicId=4978baf0-8a92-11ec-98f9-ff45c37940c6" class="button gtm_button">View live demo</a>
</div>

The live dashboard is part of the [solution template](https://winstarcloud.io/docs/paas/solution-templates/temperature-humidity-sensors/) and displays real-time data from temperature and humidity sensor collected using WinstarCloud MQTT API.
...
The diagram below identifies data flow and integration points for a typical environment monitoring solution that uses the WinstarCloud platform to collect and analyze data from IoT sensors.
