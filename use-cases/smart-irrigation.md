...
description: Irrigation management, fields provision and data visualization with WinstarCloud IoT Platform
notitle: "true"
...
The diagram below identifies data flow and integration points for a typical smart irrigation monitoring solution that uses the WinstarCloud platform to collect and analyze monitoring data from sensors.
