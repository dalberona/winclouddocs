...
description: Tank Level Monitoring with WinstarCloud IoT Platform
notitle: "true"
...
The diagram below identifies data flow and integration points for a typical fuel level monitoring solution that uses the WinstarCloud platform to collect and analyze data from fuel tanks.
...
WinstarCloud supports either plain JSON or Protobuf, which significantly optimize network traffic and increase battery life.
