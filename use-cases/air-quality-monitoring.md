...
description: Air quality monitoring, AQI determination, data visualization and device management with WinstarCloud IoT Platform
notitle: "true"
...
<div class="center" style="margin-bottom: 64px;">
    <a id="UseCases_AirQM_ViewLiveDemo" target="_blank" href="https://winstarcloud.cloud/dashboard/ec564620-82b2-11ed-a624-8360a2a6cb0e?publicId=4978baf0-8a92-11ec-98f9-ff45c37940c6" class="button gtm_button">View live demo</a>
</div>
...
The diagram below identifies data flow and integration points for a typical air quality monitoring solution that uses the WinstarCloud platform to collect and analyze monitoring data from air stations.
