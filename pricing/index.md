...
layout: pricing
title: Pricing
description: WinstarCloud Products Pricing
defaultActivePricingSection: winstarcloud-pe-options
       ...
       <nav id="inner-navigation" class="inner-navigation">
         <ul id="menu-pricing-navigation-1" class="menu">
            <li id="menu-item-winstarcloud-ce" class="menu-item tb-logo">
                <a id="Pricing_CE" href="javascript:void(0);" class="gtm_button" onClick="activatePricingSection('winstarcloud-ce')">Community Edition</a>
            </li>
            <li id="menu-item-winstarcloud-pe-options" class="menu-item tb-logo">
                <a id="Pricing_PE" href="javascript:void(0);" class="gtm_button" onClick="activatePricingSection('winstarcloud-pe-options', true)">Professional Edition</a>
            </li>
            ...
            <li id="menu-item-winstarcloud-edge" class="menu-item tb-edge-logo">
               <a id="Pricing_Edge" href="javascript:void(0);" class="gtm_button" onClick="activatePricingSection('winstarcloud-edge')">Edge</a>
            </li>
         </ul>
       </nav>
    </div>
    <div id="winstarcloud-pe-options" class="select-product-content justify-content-center align-items-center" style="display: none;">
        <div class="product-selector">
            <div id="Pricing_PE_Cloud" 
                 class="solution winstarcloud-cloud active defaultselection gtm_button" 
                 data-product-id="winstarcloud-cloud" 
                 onClick="activateProductSection('winstarcloud-cloud')">
                <h3 data-faq-id="what-is-cloud" 
                    data-faq-link-size="70%">Cloud</h3>
            </div>
            <div id="Pricing_PE_SM" class="solution winstarcloud-pe gtm_button" data-product-id="winstarcloud-pe" onClick="activateProductSection('winstarcloud-pe')">
...
<div id="winstarcloud-cloud" class="pricing-content" style="display: none;">
    <div class="container">
               ...
               <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-6 col-gt-xl mb-4">
                        <div class="pricing-square">
                            ...
                            <div class="pricing-square-description">
                                <p>Become familiar with WinstarCloud features</p>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <a id="Pricing_PE_Cloud_Maker" class="btn-blue btn-pricing gtm_button" href="https://winstarcloud.cloud/signup">
                                    Start Free
                                </a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-gt-xl mb-4">
                        <div class="pricing-square">
                            ...
                            <div class="row justify-content-center">
                                <a id="Pricing_PE_Cloud_Prototype" class="btn-blue btn-pricing gtm_button" href="https://winstarcloud.cloud/signup">
                                    Get Started
                                </a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-gt-xl mb-4">
                        <div class="pricing-square">
                            ...
                            <div class="row justify-content-center">
                                <a id="Pricing_PE_Cloud_Startup" class="btn-blue btn-pricing gtm_button" href="https://winstarcloud.cloud/signup">
                                    Get Started
                                </a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-gt-xl mb-4">
                        <div class="pricing-square">
                            ...
                            <div class="row justify-content-center">
                                <a id="Pricing_PE_Cloud_Business" class="btn-blue btn-pricing gtm_button" href="https://winstarcloud.cloud/signup">
                                    Get Started
                                </a>
                            </div>
           ...
           <div class="row justify-content-center">
                <div class="col-md-6 col-lg-6 col-xl-4 col-gt-xl mb-4">
                    <div class="pricing-square">
                        <h2>Maker</h2>
                        <div class="pricing-square-description">
                            <p>To become familiar with WinstarCloud PE features</p>
                        </div>
                        <h4 class="pricing-square-price mb-0">
                            $10
                            <span>/month</span>
           ...
           <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-4 mb-4">
                    <div class="pricing-square">
                        ...
                        <div class="pricing-square-description" style="min-height: 50px;">
                            <p>Use your WinstarCloud instance forever</p>
                        </div>
                        <h4 class="pricing-square-price mb-0">
                            $2,999
                        </h4>                  
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 mb-4">
                    <div class="pricing-square">
                        ...
                        <div class="pricing-square-item"><b>2 WinstarCloud Perpetual Kits</b></div>
    ...
    <div class="container">
        <div class="pricing-content-header row">
            <div class="pricing-content-description-cloud pricing-cloud active col-lg">
                <h2>Subscription plans</h2>
                <div class="pricing-content-details">
                    <b>Trendz Cloud</b> subscription plans include hosting, backups, maintenance and already integrated with your WinstarCloud Cloud account.
                </div>
            </div>
        </div>
        <div class="pricing-div">
...
<div id="winstarcloud-edge" class="pricing-content">
 <div class="container">
    <div class="pricing-content-header row">
           ...
           <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-4 mb-4">
                    <div class="pricing-square">
                        ...
                        <div class="pricing-square-item" data-faq-id="winstarcloud-edge-compatibility"><b>Compatible with TB CE Server</b></div>
                        <div class="pricing-square-item">Unlimited Devices and Assets</div>
                        <div class="pricing-square-item">Unlimited software updates</div>
                        <div class="pricing-square-item">Ability to contribute</div>
                        <div class="pricing-square-item" data-faq-id="community-support">
           ...
           <div class="row justify-content-center">                
                <div class="col-md-6 col-lg-6 col-xl-4 col-gt-xl mb-4">
                    <div class="pricing-square">
                        ...
                        <div class="pricing-square-item" data-faq-id="winstarcloud-edge-compatibility"><b>Compatible with TB PE Server</b></div>
                        ...
                        <div class="pricing-square-item" data-faq-id="winstarcloud-edge-discount">
                            Tiered discounts
                        </div>
                        <div class="pricing-square-item"><b>White-labeling</b></div>
                    </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4 col-gt-xl mb-4">
                    <div class="pricing-square">
                        ...
                        <div class="pricing-square-item" data-faq-id="winstarcloud-edge-compatibility"><b>Compatible with TB PE Server</b></div>
                        <div class="pricing-square-item" data-faq-id="winstarcloud-edge-unlim-devices">
           ...
           <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-4 mb-4">
                    <div class="pricing-square">
                        ...
                        <div class="pricing-square-description" style="min-height: 50px;">
                            <p>Use your WinstarCloud Edge instance forever</p>
                        </div>
                        <h4 class="pricing-square-price mb-0">
                            $399
                        </h4>
...
<div class="container faq-content">
    ...
    <div id="FAQ" class="pi-accordion">
        ...
        <div class="item" data-tag="h4" data-item-id="what-is-pay-as-you-go" data-title="What is &quot;Pay-as-you-go&quot; license?">
            <div class="container">
                <p>
                    Pay-as-you-go license is based on different subscription plans and represents a typical SaaS model. Each plan is usually limited by the number of devices or assets that WinstarCloud instance will manage. The billing is being provided either monthly or yearly.
        ...
        <div class="item" data-tag="h4" data-item-id="what-is-perpetual" data-title="What is &quot;Perpetual&quot; license?">
            <div class="container">
                <p>
                    ...
                    <br><br><b>Example 1</b>: Let's assume you purchased one license for WinstarCloud v2.4 in June 2019 and received an update to WinstarCloud v3.0 in May 2020.
                    This means you can continue using this WinstarCloud v3.0 instance forever. You can also migrate to different hardware without issues.
                    <br><br><b>Example 2</b>: Let's assume you purchased one license for WinstarCloud v2.4 in June 2019 and received an update to WinstarCloud v3.0 in May 2020.
                    This means you can continue using this WinstarCloud v3.0 instance forever. Later, in August 2020 we released v3.1. 
                    In order to get the v3.1 update, you will need to purchase an additional year of software updates for WinstarCloud PE which will cost 1199 USD. 
        ...
        <div class="item" data-tag="h4" data-item-id="can-i-migrate" data-title="Can I migrate from one subscription to another?">
            <div class="container">
                <p>
                    Yes. One of the greatest features of <a href="/products/license-server/">WinstarCloud License Server</a> is the ability to change subscription plans. 
        ...
        <div class="item" data-tag="h4" data-item-id="migrate-between-servers" data-title="Can I migrate from cloud to on-premise server using the same license?">
            <div class="container">
                <p>
                    ...
                    Notice: license check mechanism won't allow using WinstarCloud Professional Edition on two or more servers simultaneously (unless you purchase two instances of the same subscription plan).         
                </p>    
            </div>    
        </div>
       ...
       <div class="item" data-tag="h4" data-item-id="additional-services" data-title="How can I use my 10 hours bundle?">
            <div class="container">
                <p>
                 It can be your advantage for a quick start with the platform. These 10 hours can be used for consulting, training, or development services. Training sessions imply pre-defined topics, while Consulting may cover various technical questions, platform configurations, or your Use Case-related issues. The above services are conducted online. Alternatively, these 10 hours can be used to support you in the PoC, MVP, or ready-for-market solutions development by a dedicated development unit from WinstarCloud.        
                </p>    
            </div>    
        </div>    
        <div class="item" data-tag="h4" data-item-id="winstarcloud-edge-discount" data-title="Can we have a discounted price for WinstarCloud Edges in case of bulk purchase?">
            <div class="container">
                <p>
        ...
        <div class="item" data-tag="h4" data-item-id="winstarcloud-edge-compatibility" data-title="What WinstarCloud Edge compatibility means?">
            <div class="container">
                <p>
                    WinstarCloud Edge Community Edition is able to connect only to WinstarCloud Community Edition server.
                    WinstarCloud Edge Professional Edition is able to connect only to WinstarCloud Professional Edition server (it can be <a href="https://winstarcloud.cloud" target="blank">WinstarCloud Cloud</a> or on-premise instances).
                    WinstarCloud Edge Community Edition <b>can not</b> be connected to WinstarCloud Professional Edition and vise-verse.
                </p>    
            </div>
        </div>
        <div class="item" data-tag="h4" data-item-id="winstarcloud-edge-unlim-devices" data-title="What WinstarCloud Edge unlimited Devices and Assets means?">
            <div class="container">
                <p>
                    ...
                    Additionally, <b>speed of internet connection</b> between WinstarCloud Edge and WinstarCloud server must be fast to deliver huge amount of data from 'unlimited' number of devices and assets.
        ...
        <div class="item" data-tag="h4" data-item-id="trial-enable" data-title="How can I enable free trial?">
            <div class="container">
                <p>
                    Customer may <a href="https://winstarcloud.cloud/signup" target="blank">signup on WinstarCloud Professional Edition Cloud</a> and get 30 days of free trial on Maker plan. 
        ...
        <div class="item" data-tag="h4" data-item-id="trial-enable" data-title="If I want to be a re-seller of WinstarCloud, shall I have a discount?">
            <div class="container">
                <p>
                 We have clear and transparent conditions for partners. Send us a request via <a href="/docs/contact-us/" target="blank">contact us</a> and we will discuss with you all benefits of cooperation with WinstarCloud Inc.   
                </p>    
            </div>    
        </div>
        ...
        <div class="item" data-tag="h4" data-item-id="trendz-free-subscription" data-title="Can we get a trial license for Trendz Analytics?">
            <div class="container">
                ...
                Please, send us your request on <a href="/docs/contact-us/?subject=WinstarCloud%20Products">Contact us</a>.      
                </p>    
            </div>    
        </div>
        <h3 id="section3">WinstarCloud Cloud</h3>
        <div class="item" data-tag="h4" data-item-id="what-is-cloud" data-title="What is WinstarCloud Cloud?">
            <div class="container">
                <p>
                WinstarCloud Cloud is a fully managed, scalable, and fault-tolerant platform for your IoT applications with combined subscription plans based on a monthly fee which already includes hosting costs.
                </p>  
            </div>    
        </div>
        <div class="item" data-tag="h4" data-item-id="difference" data-title="What the difference between Pay-as-you-go option and WinstarCloud Cloud?">
            <div class="container">
                <p>
                Pay-as-you-go subscription plans include license fees only with no hosing services, which means that you have to deploy WinstarCloud on an external cloud (AWS, Azure, GCP, etc), or on the local server (On-premise). This means you have to pay separately for the infrastructure and manage WinstarCloud PE server.
                WinstarCloud Cloud allows you to use WinstarCloud Professional Edition platform as a service on WinstarCloud enviroment.<br><br>
                Example: Pay as you go Prototype subscription fee is $99 comparing to Prototype subscription on WinstarCloud cloud which is $149. WinstarCloud Cloud Prototype subscription price differs from the Prototype plan for the self-managed license by hosting fee which included in the Cloud subscription price
                </p>  
            </div>    
        </div>
        <div class="item" data-tag="h4" data-item-id="calculate" data-title="How we calculate Enterprise plan price?">
            <div class="container">
                ...
                The price <b>per-device</b> starts from <b>USD 0.01</b> per month and is determined based on the data points each device generates. <a href="https://winstarcloud.io/docs/contact-us/">Contact us</a> to get a precise quote for the custom Enterprise subscription.
                </p>  
            </div>    
        </div>
        <div class="item" data-tag="h4" data-item-id="api-limits" data-title="Is there any API Limits?">
            <div class="container">
                <p>
                Yes, WinstarCloud Cloud subscriptions have Entity, API and Rate limits. See subscription <a href="/products/paas/subscription/" target="blank">documentation</a> for more details.
                </p>  
            </div>    
        </div>
        <div class="item" data-tag="h4" data-item-id="data-points" data-title="What is a data point?">
            <div class="container">
                ...
                Each WinstarCloud Cloud subscription plan has a maximum number of data points that can be sent from all your devices per month. 
        ...
        <div class="item" data-tag="h4" data-item-id="white-labeling" data-title="What is a white-labeling?">
            <div class="container">
                <p>
               WinstarCloud web interface allows you to configure your company or product logo and color scheme in 2 minutes with zero coding efforts and no service restart required. 
        ...
        <div class="item" data-tag="h4" data-item-id="community-support" data-title="What does community support mean?">
            <div class="container">
                <p>
                Community support is free-of-charge option. It is a volonteering initiative, provided by our team and other WinstarCloud contributors. 
                Please, be aware that support services is one of WinstarCloud Inc. business fields. 
                Although our engineers successfully handle community support requests in their free time, this doesn't mean any obligation for WinstarCloud Inc.
                We encourage you to <a href="/docs/">read documentation</a>, subscribe to our <a href="https://www.youtube.com/c/winstarcloud" target ="blank">YouTube channel</a> where we host <a href="https://www.youtube.com/watch?v=M0CaascgDmg&list=PLYEKB_XwLCZJ6T8RPLTjRwMw0eoabpEKO" target="blank">the free Education course</a> and most demanded tutorials, samples and guides.
                </p>
        ...
        <div class="item" data-tag="h4" data-item-id="professional-support" data-title="What support plans do you have?">
            <div class="container">
                <p>
                We provide support bundles which contain server issues and application development tips. Please review WinstarCloud professional <a href="/docs/services/support/" target="blank">support plans</a>. Also we will add ability to buy support plan from <a href="https://license.winstarcloud.io/">License portal</a>.
                </p>    
            </div>    
        </div>
        <div class="item" data-tag="h4" data-item-id="optional-support" data-title="What does this optional support for WinstarCloud Edge mean?">
            <div class="container">
                <p>
        ...
        <div class="item" data-tag="h4" data-item-id="policies" data-title="Refund and Delivery Policy">
            <div class="container">
                ...
                See <a href="https://winstarcloud.io/docs/user-guide/install/pe/installation-options/">Installation Guides</a> for more details.
                ...
                Please <a href="https://winstarcloud.io/docs/contact-us/">contact us</a> if you have any questions or require support.
                </p>
               <p></p>
            </div>    
        </div>
