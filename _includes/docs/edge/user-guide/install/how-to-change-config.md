...
This guide will help you to get familiar with WinstarCloud Edge configuration files and parameters. We **recommend** to
configure WinstarCloud Edge using environment variables. This way you do not need to merge the configuration files when new
...
If WinstarCloud Edge is installed on **Linux**, you may specify the environment variables in the tb-edge.conf file:
...
If WinstarCloud Edge is installed on **Windows**, you may specify the environment variables in
...
If WinstarCloud Edge is installed in a docker compose environment, you may edit the scripts and add environment variables for
