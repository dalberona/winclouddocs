...
Additionally, the [WinstarCloud PE Mobile Application](/docs/pe/mobile/) allows users to receive instant push notifications directly on their smartphone. This ensures that you will always be timely informed about any events in your IoT solution, no matter where you are.
Follow [this guide](/docs/pe/mobile/getting-started/) to learn how to install the WinstarCloud PE Mobile Application and set up push notifications delivery directly from WinstarCloud instance to your smartphone.

## Step 7. Share dashboard with customers

One of the most important WinstarCloud features is the ability to create end-user dashboards.
