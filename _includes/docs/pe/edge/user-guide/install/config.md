...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td> Instance data is auto-generated and is used to identify particular WinstarCloud Edge Instance.
 Instance data is periodically updated and stored into the specified file which can be set to absolute or relative path.
 Please make sure that winstarcloud edge process has access to the instance data file, in case you use absolute path.</td>
		</tr>
	</tbody>
</table>
