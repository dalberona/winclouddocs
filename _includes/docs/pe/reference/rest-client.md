...
final String username = "sysadmin@winstarcloud.org";
...
final String tenantUsername = "testtenant@winstarcloud.org";
...
String userEmail = "user@winstarcloud.org";
...
```
You can find the example application **[here](https://github.com/winstarcloud/tb-pe-rest-client-example)**.
