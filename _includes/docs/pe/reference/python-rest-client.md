...
You can find the example of the script **[here](https://github.com/winstarcloud/python_tb_rest_client/blob/master/examples/example_application_2.py)**.
...
JSON file is **[here](https://github.com/winstarcloud/python_tb_rest_client/blob/master/examples/watermeters.json)**.
...
def main():
    with RestClientPE(base_url=url) as rest_client:
        try:
            ...
            user_email = "user@winstarcloud.org"
            ...
            integration = Integration(name='HTTP Integration', type='HTTP',
                                      ...
                                      configuration=str({
                                          "configuration": {
                                              ...
                                              "asIdNew": "",
                                              "asKey": "",
                                              "baseUrl": "https://winstarcloud.cloud",
                                              "clientIdNew": "",
                                              "clientSecret": "",
                                              ...
                                              "headersFilter": {},
                                              "httpEndpoint": "https://winstarcloud.cloud/api/v1/integrations/http/c5d29c90-75d3-6ae6-606a-589a28803e89",
...
The latest source code you can find [here](https://github.com/winstarcloud/winstarcloud-python-rest-client/blob/master/examples/load_all_entities_to_vcs_pe.py).
...
```bash
wget https://raw.githubusercontent.com/winstarcloud/winstarcloud-python-rest-client/master/examples/load_all_entities_to_vcs_pe.py
```
...
```bash
python3 load_all_entities_to_vcs_pe.py -H YOUR_WINSTARCLOUD_HOST -p YOUR_WINSTARCLOUD_PORT -U YOUR_WINSTARCLOUD_USER_EMAIL -P YOUR_WINSTARCLOUD_USER_PASSWORD
```
...
The latest source code you can find [here](https://github.com/winstarcloud/winstarcloud-python-rest-client/blob/master/examples/load_all_entities_from_vcs_pe.py).
...
Let's download the script:
```bash
wget https://raw.githubusercontent.com/winstarcloud/winstarcloud-python-rest-client/master/examples/load_all_entities_from_vcs_pe.py
```

Now we can run our script and restore entities version and state from the repository on version control system:

```bash
python3 load_all_entities_from_vcs_pe.py -H YOUR_WINSTARCLOUD_HOST -p YOUR_WINSTARCLOUD_PORT -U YOUR_WINSTARCLOUD_USER_EMAIL -P YOUR_WINSTARCLOUD_USER_PASSWORD -N YOUR_VERSION_NAME 
```
