...
WinstarCloud allows you to schedule various types of events with flexible schedule configuration.
WinstarCloud Scheduler fires configured scheduler events according to their schedule.
...
Tenant administrator and customer users are able to configure **Scheduler events** in WinstarCloud.
...
WinstarCloud provides ability to manage scheduler events via **Scheduler events** or **Reports schedule** Widgets which is part of **Scheduling** Widgets Bundle.
