...
WinstarCloud web interface allows you to configure your company or product logo and color scheme in a few clicks with zero coding efforts and no service restart required.
...
![image](/images/user-guide/white-labeling/accent-palette.png)
 ...
 - Advanced CSS - you can stylize any elements of the WinstarCloud user interface as you wish. We will talk more about this functionality [below](#advanced-css);
...
Using CSS, you can stylize any elements of the WinstarCloud user interface as you wish. Such elements can be background, icons, fonts, etc.
...
Using the functionality described in this documentation, you can customize the appearance of the WinstarCloud UI according to your preferences.
