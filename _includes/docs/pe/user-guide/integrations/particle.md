...
After integrating Particle with the WinstarCloud, you can connect, manage, communicate, process, and visualize data from your devices in the WinstarCloud IoT platform.

## Particle Integration Tutorial

In this tutorial, we will use a development board Particle Photon.  
You can use any other Particle device to connect it to Particle and get the data in WinstarCloud.  
...
After connecting the device, it will become visible on the Particle console. This will allow you to create an integration to receive data on WinstarCloud.  

![Devices list](/images/user-guide/integrations/particle/particle-console-device-list.png)

## WinstarCloud Integration Configuration

To receive data from Particle Console, we need to create an integration on WinstarCloud and get a URL for Particle Integration.  

### Uplink Converter

Before setting up a **Particle integration**, you need to create an **Uplink Converter**, a script for parsing and transforming the data received by Particle integration to a format that WinstarCloud can consume.
...
Now, we should create an integration in WinstarCloud. To do this, you can follow next steps:  
...
Let's return to WinstarCloud and configure the dashboard to control device.  
