...
ThingPark Integration allows to stream data from Actility ThingPark servers to WinstarCloud and converts binary device payloads to the WinstarCloud format.
...
- To create a new Integration on the WinstarCloud platform with the ThingPark Wireless OSS intelligent logger (Actility) platform, click on the link.
