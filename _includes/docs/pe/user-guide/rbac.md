...
## WinstarCloud CE vs PE security features comparison

#### WinstarCloud Community Edition

![image](/images/user-guide/security/rbac/TB_CE.png)

WinstarCloud Community Edition supports a straight-forward security model with three main roles: *System administrator*, *Tenant administrator*, and *Customer user*. 
...
WinstarCloud Community Edition functionality is sufficient for a lot of simple use cases, especially building real-time [end-user dashboards](/docs/{{docsPrefix}}user-guide/dashboards/).

#### WinstarCloud Professional Edition

![image](/images/user-guide/security/rbac/TB_PE.png)

WinstarCloud Professional Edition brings much more flexibility in terms of user, customer, and role management. 
...
WinstarCloud supports the "recursive" customer hierarchy with tens of thousands of sub-customers.
...
The WinstarCloud Professional Edition security model support advanced RBAC for IoT applications and includes security features such as:
...
This document covers features that are exclusive to WinstarCloud Professional Edition. We will start with a glossary and will provide step-by-step examples of how to configure the most popular use cases.
...
Users are able to login to the WinstarCloud web interface, execute REST API calls, access devices, and assets if it's allowed. The User is also an Entity in WinstarCloud.
...
An Entity can be a device, asset, user, dashboard, entity view, etc. Any entity is managed by WinstarCloud. See [entities and relations](/docs/{{docsPrefix}}user-guide/entities-and-relations/) guide for more details.
...
If the Customer owner is another Customer, it means that this is a sub-customer. There might be multiple levels of Customers in WinstarCloud.

**Resource**

Anything that has the secure APIs or represents a WinstarCloud Entity is a resource. 
...
In WinstarCloud Professional Edition, there are two types of roles: [Generic](/docs/{{docsPrefix}}user-guide/rbac/#generic-roles) and [Group](/docs/{{docsPrefix}}user-guide/rbac/#group-roles). Each role type has its own permissions.
...
WinstarCloud use special “connection” called Group Permission Entity (GPE) which grants permissions of Generic Role for User Group.
...
| API Usage State               | "All", "Read", "Read Telemetry"                                                                                                                                                                                                                                                                    | API Usage layout is in the main menu of the WinstarCloud platform. API Usage shows full statistics on the platform. Learn more about API Usage [here](/docs/{{docsPrefix}}user-guide/ui/aliases/#api-usage-state).                                                                                                                                                                                                                                                                                                                                          |
...
| Edge                          | "All", "Change Owner", "Create", "Delete", "Read", "Read Attributes", "Read Telemetry", "Write", "Write Attributes", "Write Telemetry"                                                                                                                                                             | WinstarCloud Edge is an extension of the WinstarCloud platform designed for local data processing and device management in a distributed IoT environment. WinstarCloud Edge supports offline operation when there is no access to the cloud-based WinstarCloud server. Find out more information about a device [here](/docs/{{docsPrefix}}edge/getting-started-guides/what-is-edge/).                                                                                                                                                                         |
...
| Integration                   | "All", "Change Owner", "Create", "Delete", "Read", "Read Attributes", "Read Telemetry", "Write", "Write Attributes", "Write Telemetry"                                                                                                                                                             | Integration is the process of connecting and interacting WinstarCloud with other systems or devices to exchange and manage data. To know more about the entity groups check the article [here](/docs/user-guide/integrations/).                                                                                                                                                                                                                                                                                                                             |
...
| Profile                       | “All”, “Read”, “Write”, “Create”, “Delete”                                                                                                                                                                                                                                                         | With these permissions, the user can edit their profile information and change the login password for their WinstarCloud instance.                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Role                          | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | Roles in WinstarCloud define a set of permissions and access rights assigned to users to perform specific actions in the system. Roles allow limiting or granting access to functionality and data based on the user’s role.                                                                                                                                                                                                                                                                                                                                |
| Rule Chain                    | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | Rule Chain in WinstarCloud is a sequence of rules and actions applied to data received from devices or other sources. Rule Chains automate data processing, enable decision-making based on specific conditions, and perform actions such as notifications, device state changes, and other operations. Rule Chains can be configured to process and route data for various purposes, simplifying the development and deployment of IoT logic in the WinstarCloud system. Learn more about rule chain [here](/docs/{{docsPrefix}}user-guide/ui/rule-chains/). |
...
| Tenant                        | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | Winstarcloud tenant is an individual user or organization that has a separate space to manage their devices and data within the WinstarCloud platform. Learn more about users [here](/docs/{{docsPrefix}}user-guide/ui/tenants/).                                                                                                                                                                                                                                                                                                                            |
| User                          | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | User is an entity that can log in to the WinstarCloud web interface, execute REST API calls, access devices, assets and other entities if they have permissions to do so. Learn more about users [here](/docs/{{docsPrefix}}user-guide/ui/users/).                                                                                                                                                                                                                                                                                                          |
...
| Version Control               | “All”, “Delete”, “Read”, “Write”                                                                                                                                                                                                                                                                   | WinstarCloud Version Control service provides the ability to export and restore WinstarCloud Entities using Git. Learn more about Version Control [here](/docs/{{docsPrefix}}user-guide/version-control/).                                                                                                                                                                                                                                                                                                                                                   |
...
To summarize those requirements in WinstarCloud terms, we should implement the following roles:
...
Let's configure WinstarCloud to support this use case. The instructions below assume that you have logged in as a Tenant Administrator.
...
5. Click on the "+" sign at the top right of the screen. Input email address, for instance, we can use _janesmith@winstarcloud.io_, and click "Add";
...
3. Input email address, for example, we will use _bob@winstarcloud.io_, then click "Add";
