...
<table>
	...
	<tbody>
		<tr>
			...
			<td>org.winstarcloud.server.extensions,org.winstarcloud.rule.engine</td>
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>https://raw.githubusercontent.com/winstarcloud/winstarcloud-pe-ui-help/release-3.7</td>
...
<table>
	...
	<tbody>
		<tr>
			...
			<td>Winstarcloud Cluster</td>
			<td> Winstarcloud cluster name</td>
		</tr>
		<tr>
			<td>cassandra.keyspace_name</td>
			<td>CASSANDRA_KEYSPACE_NAME</td>
			<td>winstarcloud</td>
			<td> Winstarcloud keyspace name</td>
		</tr>
		<tr>
			<td>cassandra.url</td>
			<td>CASSANDRA_URL</td>
 ...
 A key store is only needed if the Cassandra server requires client authentication</td>
		...
		<tr>
			...
			<td></td>
			<td> /etc/winstarcloud/astra/secure-connect-winstarcloud.zip</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>5000</td>
			<td> Sets the timeout, in milliseconds, of a native connection from WinstarCloud to Cassandra. The default value is 5000</td>
		</tr>
		<tr>
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>org.winstarcloud.server.dao.WinstarcloudPostgreSQLDialect</td>
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>jdbc:postgresql://localhost:5432/winstarcloud</td>
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>https://github.com/winstarcloud/winstarcloud/blob/master/LICENSE</td>
...
####  Mobile application settings for Winstarcloud mobile application
...
<table>
	...
	<tbody>
		<tr>
			...
			<td>winstarcloud.cloud</td>
			<td> Server domain name for Winstarcloud Live mobile application</td>
		</tr>
		<tr>
			<td>mobileApp.googlePlayLink</td>
			<td>TB_MOBILE_APP_GOOGLE_PLAY_LINK</td>
			<td>https://play.google.com/store/apps/details?id=org.winstarcloud.cloud</td>
			<td> Link to Google Play store for Winstarcloud Live mobile application</td>
		</tr>
		<tr>
			<td>mobileApp.appStoreLink</td>
			<td>TB_MOBILE_APP_APP_STORE_LINK</td>
			<td>https://apps.apple.com/ua/app/winstarcloud-cloud/id6499209395</td>
			<td> Link to App Store for Winstarcloud Live mobile application</td>
		</tr>
	</tbody>
</table>
