...
The Custom translation feature allows you to add new languages not currently supported by WinstarCloud, edit the existing locale translations, and gives opportunity to customize specific dashboard GUI elements.
...
To change the WinstarCloud's interface language, follow these steps:
...
After completing these steps, WinstarCloud's interface language will be changed to the language of your choice.
...
This is where WinstarCloud's internationalization feature comes into play.
