...
WinstarCloud server nodes act as an HTTP Server that supports both HTTP and HTTPS protocols.
...
```shell
http(s)://$WINSTARCLOUD_HOST_NAME/api/v1/$ACCESS_TOKEN/telemetry
```
{: .copy-code}

Where
- **$WINSTARCLOUD_HOST_NAME** - the hostname or IP address your platform is running on;
...
```shell
https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/telemetry
```
{: .copy-code}
...
```shell
https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/telemetry
```
{: .copy-code}
...
{% if docsPrefix == null %}
```shell
curl -v -X POST --data "{"temperature":42,"humidity":73}" https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "pe/" %}
...
{% if docsPrefix == "paas/" %}
```shell
curl -v -X POST --data "{"temperature":42,"humidity":73}" https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "edge/" %}
```shell
curl -v -X POST --data "{"temperature":42,"humidity":73}" http://$WINSTARCLOUD_EDGE_HOST_NAME/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
...
{% if docsPrefix == null %}
```shell
curl -v -X POST -d @telemetry-data-as-object.json https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "pe/" %}
...
{% if docsPrefix == "paas/" %}
```shell
curl -v -X POST -d @telemetry-data-as-object.json https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "edge/" %}
```shell
curl -v -X POST -d @telemetry-data-as-object.json http://$WINSTARCLOUD_EDGE_HOST_NAME/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
...
{% if docsPrefix == null %}
```shell
curl -v -X POST -d @telemetry-data-as-array.json https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "pe/" %}
...
{% if docsPrefix == "paas/" %}
```shell
curl -v -X POST -d @telemetry-data-as-array.json https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "edge/" %}
```shell
curl -v -X POST -d @telemetry-data-as-array.json http://$WINSTARCLOUD_EDGE_HOST_NAME/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
...
{% if docsPrefix == null %}
```shell
curl -v -X POST -d @telemetry-data-with-ts.json https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "pe/" %}
...
{% if docsPrefix == "paas/" %}
```shell
curl -v -X POST -d @telemetry-data-with-ts.json https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "edge/" %}
```shell
curl -v -X POST -d @telemetry-data-with-ts.json http://$WINSTARCLOUD_EDGE_HOST_NAME/api/v1/$ACCESS_TOKEN/telemetry --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://$WINSTARCLOUD_HOST_NAME/api/v1/$ACCESS_TOKEN/attributes
```
{: .copy-code}
...
```shell
https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/attributes
```
{: .copy-code}
...
```shell
https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/attributes
```
{: .copy-code}
...
{% endif %}
{% if docsPrefix == "pe/" %}
Don't forget to replace <code>$WINSTARCLOUD_HOST_NAME</code> with your host and port and <code>$ACCESS_TOKEN</code> with your device's access token.
{% endif %}
{% if docsPrefix == "paas/" %}
Don't forget to replace <code>$ACCESS_TOKEN</code> with your device's access token.
{% endif %}
{% if docsPrefix == "edge/" %}
Don't forget to replace <code>$WINSTARCLOUD_EDGE_HOST_NAME</code> with your host and port and <code>$ACCESS_TOKEN</code> with your device's access token.
{% endif %}
...
{% if docsPrefix == null %}
```shell
curl -v -X POST --data "{"attribute1": "value1", "attribute2":true, "attribute3": 43.0}" https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/attributes --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "pe/" %}
```shell
curl -v -X POST --data "{"attribute1": "value1", "attribute2":true, "attribute3": 43.0}" http://$WINSTARCLOUD_HOST_NAME/api/v1/$ACCESS_TOKEN/attributes --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "paas/" %}
```shell
curl -v -X POST --data "{"attribute1": "value1", "attribute2":true, "attribute3": 43.0}" https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/attributes --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "edge/" %}
...
{% if docsPrefix == null %}
```shell
curl -v -X POST -d @new-attributes-values.json https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/attributes --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "pe/" %}
```shell
curl -v -X POST -d @new-attributes-values.json http://$WINSTARCLOUD_HOST_NAME/api/v1/$ACCESS_TOKEN/attributes --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "paas/" %}
```shell
curl -v -X POST -d @new-attributes-values.json https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/attributes --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "edge/" %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://$WINSTARCLOUD_HOST_NAME/api/v1/$ACCESS_TOKEN/attributes?clientKeys=attribute1,attribute2&sharedKeys=shared1,shared2
```
{: .copy-code}
...
```shell
https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/attributes?clientKeys=attribute1,attribute2&sharedKeys=shared1,shared2
```
{: .copy-code}
...
```shell
https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/attributes?clientKeys=attribute1,attribute2&sharedKeys=shared1,shared2
```
{: .copy-code}
...
{% if docsPrefix == null %}
Execute the command. Don't forget to replace <code>demo.winstarcloud.io</code> with your host and <code>$ACCESS_TOKEN</code> with your device's access token. In this example, the hostname references live demo server.
{% endif %}
{% if docsPrefix == "pe/" %}
Execute the command. Don't forget to replace <code>$WINSTARCLOUD_HOST_NAME</code> with your host and port and <code>$ACCESS_TOKEN</code> with your device's access token.
{% endif %}
{% if docsPrefix == "paas/" %}
Execute the command. Don't forget to replace <code>$ACCESS_TOKEN</code> with your device's access token.
{% endif %}
{% if docsPrefix == "edge/" %}
Execute the command. Don't forget to replace <code>$WINSTARCLOUD_EDGE_HOST_NAME</code> with your host and port and <code>$ACCESS_TOKEN</code> with your device's access token.
{% endif %}

{% if docsPrefix == null %}
```shell
curl -v -X GET "https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/attributes?clientKeys=attribute1,attribute2&sharedKeys=shared1,shared2"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "pe/" %}
...
{% if docsPrefix == "paas/" %}
```shell
curl -v -X GET "https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/attributes?clientKeys=attribute1,attribute2&sharedKeys=shared1,shared2"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "edge/" %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://$WINSTARCLOUD_HOST_NAME/api/v1/$ACCESS_TOKEN/attributes/updates
```
{: .copy-code}
...
```shell
https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/attributes/updates
```
{: .copy-code}
...
```shell
https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/attributes/updates
```
{: .copy-code}
...
{% if docsPrefix == null %}
```shell
curl -v -X GET https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/attributes/updates?timeout=20000
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "pe/" %}
...
{% if docsPrefix == "paas/" %}
```shell
curl -v -X GET https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/attributes/updates?timeout=20000
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "edge/" %}
```shell
curl -v -X GET http://$WINSTARCLOUD_EDGE_HOST_NAME/api/v1/$ACCESS_TOKEN/attributes/updates?timeout=20000
```
{: .copy-code}
{% endif %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://$WINSTARCLOUD_HOST_NAME/api/v1/$ACCESS_TOKEN/rpc
```
{: .copy-code}
...
```shell
https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/rpc
```
{: .copy-code}
...
```shell
https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/rpc
```
{: .copy-code}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://$WINSTARCLOUD_HOST_NAME/api/v1/$ACCESS_TOKEN/rpc/{$id}
```
{: .copy-code}
...
```shell
https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/rpc/{$id}
```
{: .copy-code}
...
```shell
https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/rpc/{$id}
```
{: .copy-code}
...
```shell
curl -v -X GET https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/rpc?timeout=20000
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "edge/" %}
...
{% if docsPrefix == "paas/" %}
```shell
curl -v -X POST -d @rpc-response.json https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/rpc/1 --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "edge/" %}
...
```shell
curl -X POST -d @rpc-client-request.json https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/rpc --header "Content-Type:application/json"
```
{: .copy-code}
{% endif %}
{% if docsPrefix == "edge/" %}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://$WINSTARCLOUD_HOST_NAME/api/v1/$ACCESS_TOKEN/claim
```
{: .copy-code}
...
```shell
https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/claim
```
{: .copy-code}
...
```shell
https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/claim
```
{: .copy-code}
...
{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://$WINSTARCLOUD_HOST_NAME/api/v1/provision
```
{: .copy-code}

Where **$WINSTARCLOUD_HOST_NAME** - the hostname or IP address your platform is running on;
{% endif %}
{% if docsPrefix == null %}
If you use live demo server, the command will look like this:

```shell
https://demo.winstarcloud.io/api/v1/provision
```
{: .copy-code}
...
```shell
https://winstarcloud.cloud/api/v1/provision
```
{: .copy-code}
{% endif %}
...
When WinstarCloud initiates the firmware update over HTTP it sets the fw_title, fw_version, fw_checksum, fw_checksum_algorithm shared attributes.
To receive the shared attribute updates, the device has to GET request

{% if docsPrefix == null or docsPrefix == "pe/" %}
```shell
http(s)://$WINSTARCLOUD_HOST_NAME/api/v1/$ACCESS_TOKEN/firmware?title=$TITLE&version=$VERSION
```
{: .copy-code}
...
```shell
https://demo.winstarcloud.io/api/v1/$ACCESS_TOKEN/firmware?title=$TITLE&version=$VERSION
```
{: .copy-code}
...
```shell
https://winstarcloud.cloud/api/v1/$ACCESS_TOKEN/firmware?title=$TITLE&version=$VERSION
```
{: .copy-code}
...
HTTP transport can be fully customized for specific use-case by changing the corresponding [module](https://github.com/winstarcloud/winstarcloud/tree/master/transport/http).
