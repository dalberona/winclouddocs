...
The latest source code you can find [here](https://github.com/winstarcloud/winstarcloud-python-rest-client/blob/master/examples/load_all_entities_from_vcs_ce.py).
