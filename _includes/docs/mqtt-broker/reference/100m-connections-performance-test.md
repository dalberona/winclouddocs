...
(i.e. `publish_msg`, after [Kafka topics renaming [1]](https://github.com/winstarcloud/tbmq/commit/8871403fcfdce3489ee2a49c1505b998ceb46c3c#diff-85b2fafc998caf1c7d67f51c40f5639ac9ee0ee68379e07ad2f63b083f010f13) `tbmq.msg.all`, 
...
To solve this issue, we implemented a distinct executor service dedicated to processing publish [callbacks for Kafka producers[2]](https://github.com/winstarcloud/tbmq/commit/4e8e6d8a2f9855c7df88074efc935cb7d19f593d). 
This measure effectively resolved the aforementioned disconnections.

To further enhance performance, we [eliminated the need for a specialized publishing queue[3]](https://github.com/winstarcloud/tbmq/commit/443e260924e214ae89b0158a6369b06f38801bd0) 
...
UUID generation[4]](https://github.com/winstarcloud/tbmq/commit/47e674589269bb45291f471528c54370ebdaf7ed), 
and the adoption of a mechanism for sending messages [without the need for explicit flushing[5]](https://github.com/winstarcloud/tbmq/commit/3ec317072dead5cb5355d29dd7319ccde3403d04).
...
These enhancements [6](https://github.com/winstarcloud/tbmq/commit/56ede8e5ebbaa8deafd24b7a0d4050401835ebc0), 
[7](https://github.com/winstarcloud/tbmq/commit/395d48917be0186fafbdfa12c0a9b145b66f31d2), 
[8](https://github.com/winstarcloud/tbmq/commit/fa424ffc32837b4d4aa48b890eb3bc06908a7476) 
...
To address this concern, we devised a mechanism to ensure an [even distribution of clients among the broker nodes[9]](https://github.com/winstarcloud/tb-mqtt-perf-tests/commit/bd7649a9321f56f68303b380e634617fa0abc098), 
...
To gauge the progress, we can examine the `client_session` (after [Kafka topics renaming [1]](https://github.com/winstarcloud/tbmq/commit/8871403fcfdce3489ee2a49c1505b998ceb46c3c#diff-85b2fafc998caf1c7d67f51c40f5639ac9ee0ee68379e07ad2f63b083f010f13) `tbmq.client.session`) 
...
In addition, you may explore the [branch](https://github.com/winstarcloud/tbmq/tree/100M/k8s/aws#readme) 
containing the scripts and parameters employed for running TBMQ during this performance test.
Lastly, the [performance tests tool](https://github.com/winstarcloud/tb-mqtt-perf-tests/tree/100M) available for conducting performance tests, 
...
[publishers](https://github.com/winstarcloud/tb-mqtt-perf-tests/blob/100M/k8s/broker-tests-publishers-config.yml) and
[subscribers](https://github.com/winstarcloud/tb-mqtt-perf-tests/blob/100M/k8s/broker-tests-subscribers-config.yml) 
...
on [GitHub](https://github.com/winstarcloud/tbmq) and [Twitter](https://twitter.com/winstarcloud).

### Reference Commits

[1] - [Kafka topics renaming](https://github.com/winstarcloud/tbmq/commit/8871403fcfdce3489ee2a49c1505b998ceb46c3c#diff-85b2fafc998caf1c7d67f51c40f5639ac9ee0ee68379e07ad2f63b083f010f13).

[2] - [Kafka producer callbacks](https://github.com/winstarcloud/tbmq/commit/4e8e6d8a2f9855c7df88074efc935cb7d19f593d).

[3] - [Stop adding publish messages to queue](https://github.com/winstarcloud/tbmq/commit/443e260924e214ae89b0158a6369b06f38801bd0).

[4] - [Msg pack processing, UUID generation improvements](https://github.com/winstarcloud/tbmq/commit/47e674589269bb45291f471528c54370ebdaf7ed).

[5] - [Send messages without flush](https://github.com/winstarcloud/tbmq/commit/3ec317072dead5cb5355d29dd7319ccde3403d04).

[6] - [ClientSessionInfo object reuse](https://github.com/winstarcloud/tbmq/commit/56ede8e5ebbaa8deafd24b7a0d4050401835ebc0).

[7] - [Remove application publish msg copies](https://github.com/winstarcloud/tbmq/commit/395d48917be0186fafbdfa12c0a9b145b66f31d2).

[8] - [Bytebuf in publish msg](https://github.com/winstarcloud/tbmq/commit/fa424ffc32837b4d4aa48b890eb3bc06908a7476).

[9] - [MQTT clients even distribution among broker nodes](https://github.com/winstarcloud/tb-mqtt-perf-tests/commit/bd7649a9321f56f68303b380e634617fa0abc098).
