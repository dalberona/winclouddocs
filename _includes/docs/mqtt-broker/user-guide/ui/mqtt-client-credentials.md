...
3. Select the appropriate _Client Type_:
   ...
   - **Applications**. Use for clients that subscribe to topics with high message rates and require message persistence when the client is offline, such as applications like **WinstarCloud, AWS IoT Core** etc.
