To connect your device, you'll first need to get its credentials. While WinstarCloud supports a variety of device credentials, for this guide, we will use the default auto-generated credentials, which is an access token.  
