...
Next we will create "**The Things Stack**" (TTS) integration inside the WinstarCloud.
...
- **Username**: *winstarcloud-application@ttn* (use ***Username*** from integration on TTS)
