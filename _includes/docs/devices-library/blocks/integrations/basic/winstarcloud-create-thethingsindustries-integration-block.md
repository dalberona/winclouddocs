...
Next, we will create the "**TheThingsIndustries**" integration inside the **WinstarCloud**.
...
- **Username**: *winstarcloud-data-integration@winstarcloud* (use ***Username*** from integration on The Things Stack Industries);
