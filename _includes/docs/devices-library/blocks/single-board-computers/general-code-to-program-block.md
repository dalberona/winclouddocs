...
“winstarcloud-python-client-sdk” library.
Let’s setup our project:

1. Create project folder:

    ```bash
   mkdir winstarcloud_example && cd winstarcloud_example
   ```
   {:.copy-code}
...
4. Copy and paste the following code:
   ...
   WINSTARCLOUD_SERVER = '{% if page.docsPrefix == "pe/" or page.docsPrefix == "paas/" %}winstarcloud.cloud{% else %}demo.winstarcloud.io{% endif %}'
   ...
   In the code above change values for the following variables - WINSTARCLOUD_SERVER, ACCESS_TOKEN to your credentials.
