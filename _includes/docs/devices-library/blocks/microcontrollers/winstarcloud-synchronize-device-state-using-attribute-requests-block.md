In order to get the state of the device from WinstarCloud during booting we have [functionality](/docs/{{page.docsPrefix}}reference/mqtt-api/#request-attribute-values-from-the-server) to do this in the code.  
...
...
``` 
In order for our callbacks to receive the data, we have to send a request to WinstarCloud.  