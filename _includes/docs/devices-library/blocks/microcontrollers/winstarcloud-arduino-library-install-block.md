To install WinstarCloud Arduino SDK - we will need to do the following steps:  
...
{% assign libraryInstallation = '
    ...
    ===
        image: /images/devices-library/basic/arduino-ide/manage-libraries-winstarcloud.png
        title: Put "**WinstarCloud**" into the search box and press "***INSTALL***" button for the found library.
' 
%}
...
All provided code examples require WinstarCloud Library version {% if wifininaInstallationRequired == "true" %}**0.10.2**{% else %}**0.11.1** or above{% endif %}.  
