...
<h1 style="font-size: 28px;">Welcome to the WinstarCloud Devices Library!</h1>

The Devices Library is a collection of guides and code snippets that explain how to connect popular IoT **development boards** to the WinstarCloud platform.
...
In case you wish to integrate existing **LoRaWAN, NB IoT, or SigFox** sensors into WinstarCloud, see the [How to connect my device?](/docs/{{page.docsPrefix}}getting-started-guides/connectivity/)
