...
Two-factor authentication is a state-of-the-art approach designed to provide an extra security layer. With 2FA, even though someone knows your password your WinstarCloud account is safe against malicious access.
...
### Two-factor authentication options available in WinstarCloud
