...
There are three levels of roles on the WinstarCloud platform. It is possible to create a user on each level.
...
**Important:**
<br>
In Winstarcloud Professional Edition, the Customer can create other customer users and subcustomers.
{% endcapture %}
...
4. If you selected send **activation mail option,** then you need to check your email box and find the message about the Winstarcloud account activation. 
...
**NOTE:**
<br>
To receive an email from WinstarCloud, you should set up a mail server at the system administrator level in advance.
...
4) **Login as a Customer user** lets the Tenant administrator open the Winstarcloud platform from the user UI. 
