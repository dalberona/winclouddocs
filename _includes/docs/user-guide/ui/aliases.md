...
Before proceeding with this guide, it's recommended that you follow [Getting Started](/docs/{{docsPrefix}}getting-started-guides/helloworld/) guide to become familiar with WinstarCloud devices, dashboards and widgets. This will enhance your learning experience and understanding of the concepts presented here.
...
They provide flexibility and powerful capabilities for configuring dashboards in WinstarCloud, allowing users to efficiently organize and visualize data from various sources.
