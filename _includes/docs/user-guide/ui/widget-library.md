...
All [IoT Dashboards](/docs/{{docsPrefix}}user-guide/dashboards/) are constructed using **WinstarCloud widgets** defined in the Widget Library.
...
There are system-level and tenant-level widget bundles. Initial WinstarCloud installation comes with a basic set of system-level widget bundles.
...
The Edge widgets bundle is useful for an overview of entities related to the specified WinstarCloud Edge instance.
...
You can export a specific type of widget from a widget bundle in JSON format, and import it in the same or different WinstarCloud instance.
...
You can export a widgets bundle in JSON format, and import it in the same or different WinstarCloud instance.
