...
This type of action will transfer you to the resource represented by the URL. This resource can be an HTML page, a document, an image, internal WinstarCloud page (for example, Alarms), etc.
...
After saving the changes, you can see an icon in the upper right part of the widget. Click this icon. You will be transferred to the URL specified in the action. In our case, it's the "Working with WinstarCloud widgets" documentation page.
...
WinstarCloud offers HTML widgets that allow full configuration by customizing an HTML code in their settings.
