## Introduction to winstarcloud.io

Our website is open-sourced. You may find the code of in this [repo](https://github.com/winstarcloud/winstarcloud.github.io). Everyone can contribute to the website. The flow is as follows...
...
* [Step 3] Open [winstarcloud.github.io](https://github.com/winstarcloud/winstarcloud.github.io) documentation (site) repository.
* [Step 4] Fork a repo(refer to [Fork a repo](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) guide) of the [winstarcloud.github.io](https://github.com/winstarcloud/winstarcloud.github.io) project.
...
## Local deployment of WinstarCloud documentation repo (website)

Now you can launch the website on your local machine to see the up-to-date version.
winstarcloud.io uses jekyll site generator. So, in order to run the website on localhost you need a jekyll server installed.
