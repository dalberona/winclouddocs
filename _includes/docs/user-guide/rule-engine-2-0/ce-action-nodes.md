...
More details about Alarms in the Winstarcloud can be found in [this tutorial](/docs/{{docsPrefix}}user-guide/alarms/)
...
Transform incoming Message with configured JavaScript function to String and log final value into the Winstarcloud log file. 
...
For more details how RPC works in the Winstarcloud, please read [RPC capabilities](/docs/{{docsPrefix}}user-guide/rpc/) Article.
