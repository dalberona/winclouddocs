...
and configure your WinstarCloud rule engine to be able to send notifications to Telegram App using Rest API Call extension.
...
There are several ways to get the Chat ID:
 ...
 - First of all, you need send some message to your Bot:
    ...
    <br> where **WinstarCloud_Bot** is name of the Telegram bot.
