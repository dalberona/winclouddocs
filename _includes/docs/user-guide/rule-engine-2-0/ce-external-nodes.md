...
**NOTE**: This is part of [File Storage](/docs/{{docsPrefix}}user-guide/file-storage/) feature supported by [WinstarCloud Professional Edition](/products/winstarcloud-pe/).
...
Learn more about how to configure Slack settings in Winstarcloud [here](/docs/{{docsPrefix}}user-guide/ui/slack-settings/).
...
- **Slack API token** - token to integrate Winstarcloud with Slack;
