...
WinstarCloud API consists of two main parts: device API and server-side API.
...
[**Gateway MQTT API**](/docs/{{docsPrefix}}reference/gateway-mqtt-api) allows you to connect **existing** devices to the platform using **[WinstarCloud Gateway](/docs/iot-gateway/what-is-iot-gateway/)**
