...
Whether you're looking to customize an existing app with your own source code from {% if docsPrefix == "pe/" %}[GitHub](https://github.com/winstarcloud/flutter_winstarcloud_pe_app){:target="_blank"}{% endif %}{% if docsPrefix == null %}[GitHub](https://github.com/winstarcloud/flutter_winstarcloud_app){:target="_blank"}{% endif %} or direct it to a custom host, this document will walk you through the necessary steps.
...
<intent-filter android:autoVerify="true">
    ...
    <data
        ...
        android:host="winstarcloud.cloud"
...
To launch your custom mobile application when scanning a QR code, you need to specify the "[App package name](#app-package-name)" and "[SHA256 certificate fingerprints](#sha256-certificate-fingerprints)" in the [WinstarCloud Mobile app QR code widget settings](/docs/{{peDocsPrefix}}user-guide/ui/mobile-qr-code/#configuring-qr-code-widget-on-home-page){:target="_blank"}.
...
```text
    defaultConfig {
        ...
        applicationId "org.winstarcloud.pe.app"
    }
```
...
<dict>
	...
	<array>
		<string>applinks:winstarcloud.cloud</string>
	</array>
</dict>
</plist>
```
...
To launch your custom iOS mobile application when scanning a QR code, you need to specify the "[App ID](#app-id)" in the [WinstarCloud Mobile app QR code widget settings](/docs/{{peDocsPrefix}}user-guide/ui/mobile-qr-code/#configuring-qr-code-widget-on-home-page){:target="_blank"}.
