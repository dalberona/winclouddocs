We will create a dashboard on the <b>WinstarCloud Community Edition</b> server, and add both a table and a chart widget to view temperature data on the Server and on the Edge. 
