...
For example, $HOST_NAME reference your local WinstarCloud Edge installation, MQTT port is **1883** and access token is **ABC123**:
...
**Note:** Since WinstarCloud 3.2, you are able to use basic MQTT credentials (combination of client id, user name and password ) 
