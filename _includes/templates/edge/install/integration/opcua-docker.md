...
```bash
docker pull winstarcloud/tb-pe-opc-ua-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
--name my-tb-pe-opc-ua-integration --restart always winstarcloud/tb-pe-opc-ua-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
- `-v ~/.tb-pe-opc-ua-integration-logs:/var/log/tb-opc-ua-integration`   - mounts the host's dir `~/.tb-pe-opc-ua-integration-logs` to WinstarCloud remote integration logs directory;
...
- `winstarcloud/tb-pe-opc-ua-integration:{{ site.release.pe_full_ver }}`          - docker image.
