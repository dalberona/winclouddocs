...
```bash
docker pull winstarcloud/tb-pe-coap-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
--name my-tb-pe-coap-integration --restart always winstarcloud/tb-pe-coap-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
- `-v ~/.tb-pe-coap-integration-logs:/var/log/tb-coap-integration`   - mounts the host's dir `~/.tb-pe-coap-integration-logs` to WinstarCloud remote integration logs directory;
...
- `winstarcloud/tb-pe-coap-integration:{{ site.release.pe_full_ver }}`          - docker image.
