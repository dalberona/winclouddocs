...
cloud:
    ...
    rpc:
      ...
      ssl:
        # Set to 'true' if using winstarcloud.cloud or if you have configured a TLS connection on your Server; set to 'false' otherwise.
...
Please locate and change next parameters in WinstarCloud Edge configuration file (**C:\Program Files (x86)\tb-edge\conf\tb-edge.yml**):
<br>
<br>**...**
