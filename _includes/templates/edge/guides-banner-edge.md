...
- [Getting started guide](/docs/{{docsPrefix}}getting-started/) - Provide quick overview of main WinstarCloud Edge features. Designed to be completed in 15-30 minutes:
{% endif %}
{% if currentGuide != "InstallationGuides" %}
- [Installation guides](/docs/user-guide/install/{{docsPrefix}}installation-options/) - Learn how to setup WinstarCloud Edge on various available operating systems and connect to WinstarCloud CE server.
{% endif %}
- Edge Rule Engine:
{% if currentGuide != "RuleChainTemplates" %}
  - [Rule Chain Templates](/docs/{{docsPrefix}}rule-engine/rule-chain-templates/) - Learn how to use WinstarCloud Edge Rule Chain Templates.
{% endif %}
...
{% if currentGuide != "EdgeStatus" %}
  - [Edge Status](/docs/{{docsPrefix}}features/edge-status/) - Learn about Edge Status page on WinstarCloud Edge.
{% endif %}
{% if currentGuide != "CloudEvents" %}
  - [Cloud Events](/docs/{{docsPrefix}}features/cloud-events/) -  Learn about Cloud Events page on WinstarCloud Edge.
{% endif %}    
- Use cases:
...
- [Roadmap](/docs/{{docsPrefix}}roadmap) - WinstarCloud Edge roadmap. 
{% endif %}