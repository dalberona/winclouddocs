...
- Choose your plan. For beginners we would like to recommend 2CPUs and 4GB of RAM plan. 
  ...
  Note: Advanced WinstarCloud users may choose the plan that suites their workload best. 
...
- Add "winstarcloud" tag, just-in-case, we are not going to use it in this instruction.
