Execute the following command to deploy thirdparty compnents (zookeeper, kafka, redis) and main WinstarCloud microservices: *tb-node*, *tb-web-ui* and *js-executors*:
