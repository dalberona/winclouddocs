...
```text
Created [https://sqladmin.googleapis.com/sql/v1beta4/projects/YOUR_PROJECT_ID/instances/winstarcloud-db].
...
* *winstarcloud* is the name of your database. You may input a different name. We will refer to it later in this guide using **YOUR_DB_NAME**;
...
Create "winstarcloud" database inside your postgres database server instance:

```bash
gcloud sql databases create winstarcloud --instance=$TB_DATABASE_NAME
```
{: .copy-code}
