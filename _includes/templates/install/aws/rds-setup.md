You'll need to set up PostgreSQL on Amazon RDS. WinstarCloud will use it as a main database to store devices, dashboards, rule chains and device telemetry.
