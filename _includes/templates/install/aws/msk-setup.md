You'll need to set up Kafka using Amazon MSK. WinstarCloud will use it to communicate between microservices, store unprocessed messages, etc.
...
* Make sure your MSK instance is accessible from the WinstarCloud cluster.
