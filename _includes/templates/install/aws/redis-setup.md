You'll need to set up [Amazon ElastiCache (Redis)](https://aws.amazon.com/elasticache/redis/). WinstarCloud uses cache to improve performance and avoid frequent DB reads.
