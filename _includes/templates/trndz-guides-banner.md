...
- [**Installation guides**](/docs/trendz/install/installation-options/) - Learn how to setup WinstarCloud on various available operating systems.
{% endif %}
...
- [**Share and embed Visualizations**](/docs/trendz/embed-visuals) - Learn how to add Trendz visualizations on WinstarCloud dashboard or 3rd party web pages.
{% endif %}  
<br>
