    ...
    <div class="main-bg">
        <main class="accent-circle">
            <div class="content">
                ...
                <p class="text">Trendz works with all WinstarCloud products, including: Open Source WinstarCloud Community EditionWinstarCloud Professional Edition.</p>
                <a href="/docs/trendz/connect-winstarcloud/" class="button try-pe">Learn More</a>
            </div>
            <div class="image-block">
