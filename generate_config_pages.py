...
if __name__ == '__main__':
    ...
    if tb_repo_type.lower() == "pe":
        update_page(tb_repo_abs_path + "/application/src/main/resources/winstarcloud.yml",
        ...
        update_page(tb_repo_abs_path + "/application/src/main/resources/winstarcloud-mqtt-broker.yml",
