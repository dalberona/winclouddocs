---
layout: common
title: WinstarCloud is a Google IoT Core alternative
description:
notitle: "true"
---
...
<section id="google-iot-core-alternative">
    <section class="intro">
        <main>
            <h1>WinstarCloud as a Google IoT Core alternative</h1>
            <h2 class="clari"></h2>
        </main>
    </section>
                ...
                <div class="block" style="padding-top: 160px; ">
                    <div>
                        <p>Google Cloud shut down the IoT Core service in August 2023. You might be wondering where and how to migrate. 
                           WinstarCloud is an excellent alternative to Google IoT Cloud. 
                           Launched in 2016 as an open-source project, WinstarCloud has grown to a mature platform with 1000+ customers worldwide.</p>
                        <p>WinstarCloud, Inc. provides managed services, training, support, and software development services around the platform. 
                ...
                <div class="block">
                    <div>
                        ...
                        <p>Google IoT Core acts as an MQTT Broker and provides Device Registry and Pub/Sub integration. 
                           WinstarCloud provides an alternative implementation to Google IoT Core features with similar and, in some cases, identical APIs.
                           Our platform is much more than a <a href="/docs/reference/msa/">scalable</a> service to accept and route telemetry.
                           WinstarCloud brings full IoT application enablement capabilities. See the feature comparison table below: </p>
                    </div>
                </div>
            </div>
        </main>
    ...
    <section class="matrix">
        <main>
            ...
            <div class="winstarcloud"><div class="coln"><div class="head"></div></div></div>
            </div>
            <table>
                    <thead>
                        <tr>
                            ...
                            <th>WinstarCloud<br>Professional Edition</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
        ...
        <p>Learn more about WinstarCloud features <a href="/docs/pe/getting-started-guides/what-is-winstarcloud/">here</a>.</p>
    </section>
    ...
    <section class="bottom-features">
        <main>
            ...
            <h3>Key concepts</h3>
            <p>See mapping of the key IoT Core concepts to WinstarCloud features documentation below:</p>
            <div class="row cards">
                <div class="col-lg-6">
					<div class="block">
						<div>
							<a class="title" href="/docs/pe/user-guide/ui/devices/">Device</a>
							<p>WinstarCloud supports provisioning and management of <a href="/docs/pe/user-guide/ui/devices/">devices</a> similar to Google IoT Core. 
                            However, IoT application is not only about devices. WinstarCloud supports other <a href="/docs/pe/user-guide/entities-and-relations/">entities and relations</a> between them.
                ...
                <div class="col-lg-6">
					<div class="block">
						<div>
                            ...
                            WinstarCloud allows you to collect data from devices similar to IoT Core. WinstarCloud also enables data processing (including validation, alerting, etc.) and storage inside the platform.
                ...
                <div class="col-lg-6">
					<div class="block">
						<div>
							...
							<p>WinstarCloud monitors device <a href="/docs/pe/user-guide/device-connectivity-status/">connectivity status</a>
                            ...
                            WinstarCloud also allows you to distribute over-the-air <a href="/docs/pe/user-guide/ota-updates/">firmware and software updates</a> and monitor the update process. 
                            </p>
						</div>
					</div>
				</div>
                <div class="col-lg-6">
					<div class="block">
						<div>
							...
							<p>WinstarCloud capabilities of device configuration as similar to Google IoT Core. 
                            ...
                            WinstarCloud allows to push each attribute(configuration) update separately; 
                ...
                <div class="col-lg-6">
					<div class="block">
						<div>
							...
							<p>WinstarCloud provides flexible interfaces for registering, monitoring, and configuring devices: 
                            ...
                            WinstarCloud has all the required built-in instruments to enable complex use cases.</p>
						</div>
					</div>
				</div>
                <div class="col-lg-6">
					<div class="block">
						<div>
                            ...
                            WinstarCloud also acts like an MQTT broker, but there are a few differences. 
                            With WinstarCloud, you are not limited by static topic name patterns and can define any wildcard topic filters for your needs.
                            The platform accepts JSON or protobuf payloads.
                            WinstarCloud supports <a href="/docs/pe/user-guide/access-token/">access tokens</a>,
                            ...
                            WinstarCloud also has built-in integrations with external systems like SigFox, LoRaWAN, NB IoT, etc. 
                ...
                <div class="col-lg-6">
					<div class="block">
						<div>
							...
							<p>You may send commands to and from devices with the WinstarCloud <a href="/docs/pe/user-guide/rpc/">RPC</a> feature. 
