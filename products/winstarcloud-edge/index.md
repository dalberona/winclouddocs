...
<section id="intro">
	<main>
		<h1 class="intro_title">Introducing WinstarCloud Edge <a href="/docs/edge/getting-started-guides/what-is-edge/">CE</a> and <a href="/docs/pe/edge/getting-started-guides/what-is-edge/">PE</a>: Our software products specifically designed for edge computing</h1>
        <p class="labeling">With WinstarCloud Edge, data analysis and management occur directly at the edge, right where the data is generated. Additionally, it offers seamless synchronization with the WinstarCloud server, aligning perfectly with your unique business needs. You have the flexibility to connect it to public WinstarCloud servers, such as winstarcloud.cloud or demo.winstarcloud.io, as well as to your own Community Edition (CE) or Professional Edition (PE) on-premise installations.</p>
	</main>
</section>
    ...
    <main>
        <div class="block">
            ...
            <div class="feature-des"><h3 class="item-heading">Data Filtering</h3>
                <p>Use the WinstarCloud Edge service to filter data from local (edge) devices and forward only a subset of data to the server for further processing or storage.</p>
                <a class="read-more-button" href="/docs/edge/getting-started-guides/what-is-edge/">Edge CE<img class="arrow first" src="/images/pe/read-more-arrow.svg" alt="arrow first"><img class="arrow second" src="/images/pe/read-more-arrow.svg" alt="arrow second"><img class="arrow third" src="/images/pe/read-more-arrow.svg" alt="arrow third"></a>
                <a class="read-more-button" style="margin-left: 60px;" href="/docs/pe/edge/getting-started-guides/what-is-edge/">Edge PE<img class="arrow first" src="/images/pe/read-more-arrow.svg" alt="arrow first"><img class="arrow second" src="/images/pe/read-more-arrow.svg" alt="arrow second"><img class="arrow third" src="/images/pe/read-more-arrow.svg" alt="arrow third"></a>
            </div>
        </div>
...
<section id="bottom-features">
    <main>
        ...
        <h3>More about WinstarCloud Edge strengths</h3>
        <div class="cards row">
            <div class="col-lg-6">
                <div class="block">
...
<section id="matrix">
    ...
    <table>
            <thead>
                <tr>
                    <td></td>
                    <th>WinstarCloud<br>Edge</th>
                    <th>IoT<br>Gateway</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <th>WinstarCloud Server required (CE, PE or Cloud)</th>
