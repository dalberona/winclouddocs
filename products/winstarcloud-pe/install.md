---
layout: docwithnav
title: Get WinstarCloud Professional Edition
description: WinstarCloud Professional Edition Installation
hidetoc: "true"
    ...
    <div class="tabs">
        ...
        <div class="tab-panel">
            <div id="trial-marketplace" class="choose-marketplace">
                <p>
                    Signup for free month trial on WinstarCloud PE Cloud
                </p>
                <div class="marketplace" style="padding-bottom: 10px;">
                    <div id="pe-cloud-trial" class="pricing-image-wrapper clickable" style="max-width: 50%;">
                        ...
                        <a target="_blank" href="https://winstarcloud.cloud/signup"></a>
                    </div>
                </div>
                <div style="font-size: 20px;">
                <p style="padding-top: 20px; font-size: 20px;">
                    WinstarCloud PE Cloud is a shared enviroment with multiple limitations, such as:
                </p>
                ...
                <p style="padding-top: 0px; font-size: 20px;">
                    To get the maximum of WinstarCloud PE, we recommend to install your dedicated server using one of the available options below.
                </p>
                </div>
                <div class="marketplace">
                    <div id="aws-trial-market" class="pricing-image-wrapper clickable">
                        <img src="/images/pe/aws_logo.svg" alt="aws logo">
                        <a href="/products/winstarcloud-pe/aws/"></a>
                    </div>
                            ...
                            <div class="form-section mb20">
                                <div class="cloud-provider">
                                    ...
                                    <div class="cloud-provider-desc">
                                        <p>Install WinstarCloud PE on any cloud or on premises and pay one-time license fee per server and optional software updates subscription for subsequent years of usage.
...
<script>
     function ml_webform_success_7972110() {
        ...
        $(location).attr('href', '/products/winstarcloud-pe/install-thanks/?deploy=trial');
    ...
    function ml_webform_success_7520964() {
        var $ = ml_jQuery || jQuery;
        $(location).attr('href', '/products/winstarcloud-pe/install-thanks/?deploy=cloud');
    ...
    function ml_webform_success_7556612() {
        var $ = ml_jQuery || jQuery;
        $(location).attr('href', '/products/winstarcloud-pe/install-thanks/?deploy=premise');
