...
# WinstarCloud Professional Edition on AWS Marketplace
            ...
            <tr class="price">
                ...
                <td>
                    <div class="price-cell">
                        ...
                        <p><a href="/products/winstarcloud-pe/install/aws/?instance=maker" class="button">Try it now</a></p>
                    </div>
                </td>
                <td>
                    <div class="price-cell">
                        ...
                        <div>/month</div>
                        <div class="price-desc">for software + <a href="javascript:void(0);" onClick="openAwsFaqNode('what-is-the-total-cost-of-ownership-tco-for-my-tb-pe-instance')">AWS usage fees</a></div>
                        <p><a href="/products/winstarcloud-pe/install/aws/?instance=prototype" class="button">Try it now</a></p>
                    </div>
                </td>
                <td>
                    <div class="price-cell">
                        ...
                        <div>/month</div>
                        <div class="price-desc">for software + <a href="javascript:void(0);" onClick="openAwsFaqNode('what-is-the-total-cost-of-ownership-tco-for-my-tb-pe-instance')">AWS usage fees</a></div>
                        <p><a href="/products/winstarcloud-pe/install/aws/?instance=startup" class="button">Try it now</a></p>
                    </div>
                </td>
                <td>
                    <div class="price-cell">
                        ...
                        <div>/month</div>
                        <div class="price-desc">for software + <a href="javascript:void(0);" onClick="openAwsFaqNode('what-is-the-total-cost-of-ownership-tco-for-my-tb-pe-instance')">AWS usage fees</a></div>
                        <p><a href="/products/winstarcloud-pe/install/aws/?instance=business" class="button">Try it now</a></p>           
                    </div>
                </td>
                <td>
                    <div class="price-cell">
                        ...
                        <div>/month</div>
                        <div class="price-desc">for software + <a href="javascript:void(0);" onClick="openAwsFaqNode('what-is-the-total-cost-of-ownership-tco-for-my-tb-pe-instance')">AWS usage fees</a></div>
                        <p><a href="/products/winstarcloud-pe/install/aws/?instance=enterprise" class="button">Try it now</a></p>
                    </div>
                </td>
            </tr>
            <tr class="yearly-sub">
...
<div class="pi-accordion">
    ...
    <div class="item" data-tag="h4" data-item-id="what-does-free-trial-mean" data-title="How can I enable free trial?">
        <div class="container">
            <p>
                We recommend to use WinstarCloud Professional Edition Live Demo for the seamless experience and the newest features from the latest source code! 
    ...
    <div class="item" data-tag="h4" data-item-id="how-do-i-backup-db" data-title="How do I backup my database?">
        <div class="container">
            <p>
                Depending on your instance type and configuration, WinstarCloud may store data in SQL or NoSQL databases. 
                WinstarCloud may also store data using hybrid database mode. 
    ...
    <div class="item" data-tag="h4" data-item-id="how-do-i-upgrade-instance-type" data-title="How do I upgrade my instance type?">
        <div class="container">
            <p>
                ...
                WinstarCloud team is planning to have a tool for this purpose but the release is scheduled for the end of 2019. 
    ...
    <div class="item" data-tag="h4" data-item-id="how-do-i-find-logs-tb" data-title="Where is my WinstarCloud instance logs?">
        <div class="container">
            <p>
                WinstarCloud logs are stored in the <i>/var/log/winstarcloud</i> folder. 
    ...
    <div class="item" data-tag="h4" data-item-id="how-do-i-get-free-help-tb" data-title="How do I get help from community?">
        <div class="container">
            <p>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;<a href="https://github.com/winstarcloud/winstarcloud/issues">GitHub issues page</a> - Our GitHub issues page contains a lot of Q&A and discussions about WinstarCloud.<br>
                &nbsp;&nbsp;&nbsp;&nbsp;<a href="https://groups.google.com/forum/#!forum/winstarcloud">Q&A forum</a> - Our user forum is a great place to go for community support.<br>
                &nbsp;&nbsp;&nbsp;&nbsp;<a href="https://stackoverflow.com/questions/tagged/winstarcloud">Stack Overflow</a> - The WinstarCloud team will also monitor posts tagged winstarcloud. 
            </p>    
        </div>    
    </div>
    <div class="item" data-tag="h4" data-item-id="how-do-i-get-free-help-tb" data-title="How do I get professional support?">
        <div class="container">
            <p>
                Please review WinstarCloud professional <a href="/docs/services/support/">support plans</a> and <a href="/docs/contact-us/">contact us</a>. 
            </p>    
        </div>    
    </div>                            
</div>
