...
assignees:
- ashvayka
title: WinstarCloud Cloud Subscription plans definition
...
See feature [documentation](/docs/user-guide/white-labeling/) for more details. WinstarCloud Cloud extends white-labeling feature with ability to configure own domain name easily. 
