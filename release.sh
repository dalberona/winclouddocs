...
do
  ...
  find . -type f -iname "$ext" -exec sed -i -e '/https/! s/\/images\//https:\/\/img.winstarcloud.io\//g' {} \;
  find . -type f -iname "$ext" -exec sed -i -e 's/https:\/\/winstarcloud.io\/images\//https:\/\/img.winstarcloud.io\//g' {} \;
  find . -type f -iname "$ext" -exec sed -i -e '/https:\/\/img.winstarcloud.io\/partners\/map-of-distributors\.svg/ s/https:\/\/img.winstarcloud.io\/partners\/map-of-distributors\.svg/\/images\/partners\/map-of-distributors.svg/g' {} \;
done
